...
# tar --use-compress-program=unzstd -xpvf archlinux-bootstrap-x86_64.tar.zst --strip-components=1 -C /compat --numeric-owner   # 解压压缩包到 /compat：同时保持原有 GID 和 UID。若出现 tar 报错通常可忽略
```

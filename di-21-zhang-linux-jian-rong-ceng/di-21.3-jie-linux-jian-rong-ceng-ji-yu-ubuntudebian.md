...
使用文本编辑器 Ubuntu 兼容环境中的 APT 软件源配置文件 `/compat/ubuntu/etc/apt/sources.list`，写入软件源：
...
笔者试图导入过 [https://github.com/zq1997/deepin-wine](https://github.com/zq1997/deepin-wine) 源以安装 deepin-qq、deepin-wechat 等软件，但都提示“段错误”。所有 Wine 程序均无法正常运行。如果读者能解决这个问题，请提出 issue 或者 PR。
...
3. 尝试复现文中提到的 Wine 段错误问题，使用系统参数 `compat.linux.debug` 开启调试日志，分析错误发生的位置，并尝试解决。

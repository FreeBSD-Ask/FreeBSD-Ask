...
截至 2026 年 2 月 16 日，FreeBSD Ports 集合中的 [emulators/linux-rl9](https://www.freshports.org/emulators/linux-rl9/) 端口（其实际对应的基础包为 [emulators/linux_base-rl9](https://www.freshports.org/emulators/linux_base-rl9/)）基于 Rocky Linux 9.7 发行版构建。

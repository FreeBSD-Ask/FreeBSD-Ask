...
将 `sync-uri = rsync://rsync.gentoo.org/gentoo-portage` 修改为 `sync-uri = rsync://mirrors.tuna.tsinghua.edu.cn/gentoo-portage`。
...
gentoodownload=$(grep 'stage3-amd64-systemd' latest-stage3-amd64-systemd.txt | awk '{print $1}')

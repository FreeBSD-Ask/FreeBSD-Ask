...
- FreeBSD Project. Linux Binary Compatibility[EB/OL]. [2026-04-17]. <https://wiki.freebsd.org/Linuxulator>. FreeBSD 手册中关于 Linux 二进制兼容层的章节，详细说明了路径映射机制与 **/compat/linux** 目录结构。

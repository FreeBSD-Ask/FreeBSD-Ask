...
该工具包内置了用于收集系统信息的现成脚本，包括检查打开的文件、内存、CPU 使用情况等。FreeBSD 基本系统中也内置了若干脚本，存放在 **/usr/share/dtrace**，在源代码中位于 **share/dtrace/**。FreeBSD 基本系统还提供了 lockstat(1)，它基于 DTrace 采集内核锁竞争统计信息，是分析内核并发性能的关键工具。
...
此标志在编译过程中启用 DTrace 钩子，从而调试和监控模块。修改后，确保重新编译该模块以激活 DTrace 功能。

...
在 LLVM 项目上游源代码中，LLVM 19 之前的版本号规定在文件 **llvm/CMakeLists.txt** 中，[此次提交](https://github.com/llvm/llvm-project/commit/81e20472a0c5a4a8edc5ec38dc345d580681af81) 之后版本号改由源文件 [cmake/Modules/LLVMVersion.cmake](https://github.com/llvm/llvm-project/blob/main/cmake/Modules/LLVMVersion.cmake) 规定。
...
FreeBSD 将 LLVM 导入基本系统源代码中，但并非直接导入，而是经过处理。撰写本节时 FreeBSD src 内置的 LLVM 仍为 LLVM 19，因此注明版本号的文件路径位于 **lib/clang/include/clang/Basic/Version.inc**：

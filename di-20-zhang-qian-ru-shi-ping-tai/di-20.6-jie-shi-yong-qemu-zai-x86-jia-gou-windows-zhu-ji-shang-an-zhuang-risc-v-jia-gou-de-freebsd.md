# 20.6 使用 QEMU 在 x86 架构 Windows 主机上安装 RISC-V 架构的 FreeBSD
...
3. RISC-V 的开放指令集架构承诺打破 x86/ARM 双寡头的专利壁垒，但 FreeBSD 的 RISC-V 移植仍处于 Tier 3 支持级别。分析 Tier 3 到 Tier 2 升级所需满足的技术条件，并讨论开放硬件运动能否加速这一进程。

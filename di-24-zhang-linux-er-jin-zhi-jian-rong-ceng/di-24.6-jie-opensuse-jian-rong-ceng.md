...
同样，当使用 openSUSE Tumbleweed 时，dnf 和 zypper 均不可用。该问题不影响 Leap 对应的脚本，但影响 Tumbleweed 对应的脚本，导致无法正常使用。已提交 [Bug 报告](https://bugzilla.opensuse.org/show_bug.cgi?id=1213158)。

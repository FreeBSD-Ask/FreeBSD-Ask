...
怎么命名是缺乏规范的——还有许多项目，他正式版也是 dev。认为世界是有秩序的，是被预定好的，是有规律的，本身无可厚非，但是忽略了一点，在由人类构建的世界中，一切都需要人类自行维护，构建秩序。而不是指望有神预定好了一切法则。

重要的是分享大家一起玩，不是为了教育谁。实际上就是草台班子论，祛魅了，不承认有这么一个所谓大佬。

一方面指出有这样一个大佬，是不可替代的，另一方面工业化要求的是标准化和统一化。这二者是冲突的，那么肯定有一个是假象。那么唯一的答案是替代成本，而后者又要求不断地通过标准化降低这种成本。

综上，这是一种幻觉。我认为真正的问题不在于解决问题，而在于回答他究竟想干什么。如果他的目的根本不是编译的话，你为什么不能直接发个 deb 包呢？能用 Windows 完成的为什么非要在 Linux BSD 下乱搞苦难哲学。

大音希声，真正的解决问题的方式在于消解问题本身。说白了你不给钱的话，别人没啥义务，所以对面怎么回答也属合理，只是粗暴的回答者他要知道自己也并非上帝，也会有这一天。我确实看到很多人，你明确告诉他在哪，还装看不见的，这种是故意找茬的。

他提问的智慧不仅不能从根本解决问题，也不能从表面解决问题。我认为花钱解决问题并不显得愚蠢，他应该开个付费区。他说的确实很有道理不是吗，然而问题不在于有没有道理，问题在于对于一个团队的成员，这种责任是预设好的即使许可证已经在形式上 100% 免除担保，这种结构是这样的。市场化难道是什么可耻的事情吗？无论计划和市场都无法完美的进行分配，不是吗？

有现成的谁愿意挨个看文档，连问 AI 我都觉得麻烦，为什么不承认这是人类的天性？所以像 FreeBSD jail 这种原始技术根本没人用，类似的还有 bhyve 照抄都跑不起来。

再看以下场景：

>“但中文翻译有的词汇使用并不标准, 例如将library翻译为图书馆. 因此后续讲义中介绍Logisim时主要还是给出英文词汇, 并在括号中给出中文版的翻译.”

所以他为什么不去反馈不去改？是没有权限还是提交了对方也不会接受？无论如何，写在这里让人别用中文用英语，这种思路就有问题，写一下简单告诉读者在哪反馈不就行了？现在的人连原始人都不如吗？原始人还知道从打制石器到磨制石器，主动适应蹩脚的工具，是一种精神的退化。苹果那个开发工具 Xcode 也是没中文，后来全部人都是用的盗版，结果就被插入病毒了，现在也不知道悔改，还是不提供中文支持，他的逻辑是没中文就只能用我正版的英文的，然而，无论在多么恶劣的环境下，生命都会自行找到出路。

窃以为第一课应该是教人如何改造工具，从具体的小事开始做，比如复制粘贴。其忽略了一个问题：如果一个问题被新手反复提及，那么这肯定不是新人自己的问题。路不平，要修路，而不是怪人不行。

如今的思路还是先把原型弄出来再迭代，不考虑也不认为一开始的考虑和设计是有必要的。认为本质是在时间中构建的从而否定了一种不变的主体性，他认为随着不断地迭代，系统本身就会自然而然的涌现出意识，其实也是 BSD 和 Linux 的根本分歧，传统 Unix 哲学，暂且这么说，“原型先行”实际上他是形成了一种否定之否定的局面，而这实际上是忒休斯的否定——你是不是经常听过一句话，先把代码拿出来，先把轮子造出来。说白了这是技术话语权的分配问题。也不只是计算机行业这样。也就是说认为只要存在一个项目，社区就会自发地组织起来，并且是严密的组织起来。系统外围那些看起来和代码无关的内容也会自组织，并且认为他们始终毫无意义。实际上这种思想在 Sun 倒闭的时候就该没有市场了。

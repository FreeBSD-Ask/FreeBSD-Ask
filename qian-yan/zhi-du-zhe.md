...
可以看到，怎么命名 `xxx and xxx-dev` 是缺乏规范的——还有许多项目，其正式版也是 dev。认为世界是有秩序的，是被预定好的，是有规律的，本身无可厚非，但是忽略了一点，在由人类构建的世界中，一切都需要人类自行维护，构建秩序。而不是指望有神预定好了一切法则一劳永逸。
...
他提问的智慧不仅不能从根本解决问题，也不能从表面解决问题。花钱解决问题并不显得愚蠢，他应该开个付费区。他说的确实很有道理不是吗，然而问题不在于有没有道理，问题在于对于一个团队的成员，这种责任是预设好的即使许可证已经在形式上 100% 免除担保，这种结构是这样的。市场化难道是什么可耻的事情吗？无论计划和市场都无法完美的进行分配，不是吗？
...
所以他为什么不去反馈不去改？是没有权限还是提交了对方也不会接受？无论如何，写在这里让人别用中文用英语，这种思路就有问题，写一下简单告诉读者在哪反馈不就行了？现在的人连原始人都不如吗？原始人还知道从打制石器到磨制石器，主动适应蹩脚的工具，是一种精神的退化。苹果那个开发工具 Xcode 也是没中文，后来全部人都是用的盗版，结果就被插入病毒了，现在也不知道悔改，还是不提供中文支持，他的逻辑是没中文就只能用我这个正版的英文的，然而，无论在多么恶劣的环境下，生命都会自行找到出路。在没有开放 Discussion 的 GitHub 项目中，任何问题都只能作为 Issue 提出。在 Issue 也关闭的项目中，并且未提供其他更方便的渠道下，该项目将永远不存在任何问题。

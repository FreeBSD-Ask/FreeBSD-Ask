...
在计算机科学与技术快速发展的今天，操作系统作为计算机系统的核心基础设施，其重要性不言而喻。然而，当前主流操作系统教育与实践往往过度聚焦于 Linux 或 Windows 生态系统，导致 BSD 系列操作系统——这一具有深厚历史渊源和独特技术价值的系统——在中文世界逐渐被边缘化。本书的核心研究问题是：如何在保留 BSD 系统技术特色的同时，为中文读者提供一套系统化、可操作的入门与实践指南，以填补这一领域的知识空白？
...
如果您不具备上述全部知识，仍可通过本书学习 FreeBSD，但建议在遇到相关概念时查阅补充资料。
...
主要面向 Windows 用户和 Linux 用户。即使读者认为自己已经掌握了一些，也建议概览本章各节。内容包括基本命令、文件系统权限、Shell 配置等。
...
尽可能列举可在 FreeBSD 上运行的桌面环境及窗口管理器，包括 GNOME、KDE、Xfce 等常见环境，以及 i3wm、Hyprland 等平铺式窗口管理器。如果没有你喜欢的桌面环境，欢迎 PR。
...
介绍如何使用 FreeBSD 进行音视频播放，以及蓝牙、打印机等常用外部设备的配置和使用方法。

**第 10 章 代理服务器**

中文世界不可或缺的一类软件。本章暂未展开（相关软件在兼容层运行同样可用，但我们仍期待原生支持），欢迎 PR。
...
介绍 FreeBSD 上的虚拟化技术，包括 bhyve  hypervisor 以及其他容器化方案。
...
介绍游戏、科研教育工具以及一些专业软件在 FreeBSD 上的使用方法。
...
介绍如何在 FreeBSD 上搭建各种常用开发环境，以及如何参与 FreeBSD 社区贡献。
...
介绍 FreeBSD 内核选项，提供全注全译，帮助读者理解内核配置。
...
>**思考题**
>
>>美国国家标准与技术研究院（NIST）发布的数字身份指南草案（[SP800-63-4 第二版](https://pages.nist.gov/800-63-4/sp800-63b.html) [备份](https://web.archive.org/web/20260121091942/https://pages.nist.gov/800-63-4/sp800-63b.html)）指出：
>>
...
>
>>“尽管近年来不少专家一再批评现行密码规则的弊端，但银行、互联网平台和政府机构大多依然固守这些过时、无效甚至有害的规则。”——[“定期更换密码”是最愚蠢的密码规则？](https://www.goupsec.com/news/17579.html) [备份](https://web.archive.org/web/20260119043539/https://www.goupsec.com/news/17579.html)
>

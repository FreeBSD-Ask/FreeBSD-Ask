...
**第 6 章 软件管理**：介绍 FreeBSD 包管理器概述、FreeBSD 软件源的更换方法，使用 pkg 管理二进制包、使用 Ports 以源代码方式安装软件，以及使用 DVD 安装软件和 FreeBSD 镜像站现状。
...
**第 11 章 多媒体和外部设备**：介绍 Web 浏览器、声卡配置、音频与视频播放器、打印机、摄像头、人机输入设备及多媒体处理工具的使用方法。

...
> **思考题**
>
> 请读者现在就找出本书中至少一处论证逻辑无法自洽的地方，并在 GitHub 上发起拉取请求来完成修改。
...
查询手册页即可发现专门有一个条目是“BUGS”，用来表述当前软件的缺陷。
...
请相信笔者，并非仅有你觉得这些东西难用，甚至想砸键盘。这也是人们不断“造轮子”（从头实现一款工具）的原因之一。如果你觉得 GCC 难用，那么可以改用 Clang/LLVM。你绝非第一个感到 GCC 难用的人，也不会是最后一个。
...
大音希声，真正的解决问题的方式在于消解问题本身。简言之，若不付费，别人没什么义务，所以对面怎么回答也属合理。只是粗暴的回答者，他要知道自己也并非上帝，也会有这一天。确实看到很多人，明确告诉他在哪，他还装作看不见的，这种属于故意刁难。
...
所以为什么不去反馈、不去修正？是没有权限，还是提交了对方亦不会接受？无论如何，在此处建议读者弃用中文而改用英语，这种思路本身便值得商榷。简单注明反馈渠道，岂非更为妥当？当前之人难道尚不及原始先民？原始先民尚知从打制石器演进至磨制石器，主动适应蹩脚的工具，实则可能限制了改进的动力。Apple 开发工具 Xcode 长期未提供完整的中文界面支持（核心界面锁定为英文），部分用户因此使用了非官方渠道的版本，导致安全事件的发生。其逻辑是：缺乏中文支持时用户只能使用英文正版。然而，无论在多么恶劣的环境下，生命都会自行找到出路。在没有开放 Discussion 的 GitHub 项目中，任何问题都只能作为 Issue 提出；在 Issue 也关闭的项目中，并且未提供其他更方便的渠道的情况下，该项目将永远不存在任何问题。

窃以为第一课应该是教人如何改造工具，从具体的小事开始做，比如复制粘贴。其忽略了一个问题：如果新手反复提及一个问题，那么这肯定不是新人自己的问题。路不平，要修路，而不是怪人不行。

如今的思路还是先把原型构建出来再迭代，不考虑、也不认为一开始的考虑和设计是有必要的。这种思路认为本质是在时间中构建的，从而否定了一种不变的主体性；随着不断迭代，系统本身就会自然而然地涌现出意识。这实则也是 BSD 和 Linux 的根本分歧，传统 Unix 哲学，暂且这么说。“原型先行”实际上形成了一种否定之否定的局面，而这实际上是忒修斯之船式的否定，我们常听人说：先把代码拿出来，先把轮子造出来。简而言之，这是技术话语权的分配问题，也不只是计算机行业这样。认为只要存在一个项目，社区就会自发地组织起来，并且是严密地组织起来；系统外围那些看起来和代码无关的内容也会自组织，并且认为它们始终毫无意义。实际上，这种思想在 Sun 被 Oracle 收购的时候就该没有市场了。
...
> “提出一个问题往往比解决一个问题更重要。”
>
> ——爱因斯坦 A，英费尔德 L. 物理学的进化[M]. 北京：中信出版集团，2019：92. ISBN 978-7-5217-0141-8. 该书从相对论视角阐述科学哲学，强调问题意识的重要性。英文原版（Simon and Schuster, 1966）此句位于第 92 页。
...
> **思考题**
>
> 请读者现在就找出本书中存在的至少三处失效的 URL 链接、错别字或事实错误，并在 GitHub 上发起拉取请求来完成修改。
...
> **思考题**
>
> 请读者现在就找出本书中存在的至少一处描述不清晰或不准确的地方，并在 GitHub 上发起拉取请求来完成修改。

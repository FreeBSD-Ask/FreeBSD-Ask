...
如今的思路还是先把原型弄出来再迭代，不考虑、也不认为一开始的考虑和设计是有必要的。认为本质是在时间中构建的，从而否定了一种不变的主体性；随着不断迭代，系统本身就会自然而然地涌现出意识。这其实也是 BSD 和 Linux 的根本分歧，传统 Unix 哲学，暂且这么说。“原型先行”实际上形成了一种否定之否定的局面，而这实际上是忒修斯之船式的否定——我们常听人说：先把代码拿出来，先把轮子造出来。简而言之，这是技术话语权的分配问题，也不只是计算机行业这样。认为只要存在一个项目，社区就会自发地组织起来，并且是严密地组织起来；系统外围那些看起来和代码无关的内容也会自组织，并且认为它们始终毫无意义。实际上，这种思想在 Sun 倒闭的时候就该没有市场了。

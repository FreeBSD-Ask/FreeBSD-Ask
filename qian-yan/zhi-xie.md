...
本书初版架构基于 Smile_Zheng. 操作系统笔记[EB/OL]. 百度贴吧. [2026-04-04]. <https://tieba.baidu.com/p/7424071955>. 主要引用了防火墙章节、用户与权限章节。原笔记主要转引了《FreeBSD 技术内幕》（Urban M, Tiemann B. FreeBSD 技术内幕（FreeBSD Unleashed）[M]. 智慧东方工作室，译. 北京：机械工业出版社，2002.），以及参考了 [🎀🌸 星不萌 🌸🎀](https://tieba.baidu.com/home/main?un=%E6%98%9F%E5%85%89Re) 的博客文章（[互联网档案馆存档](https://web.archive.org/web/20201128071425/https://www.moebsd.cn/)）。

在第二版中，除防火墙章节外，已经移除了所有对“操作系统笔记”（实际上是《FreeBSD 技术内幕》）的引用。

在第三版中，移除了对“🎀🌸 星不萌 🌸🎀”博客的所有引用、彻底移除了所有对“操作系统笔记”的引用；还援引 FreeBSD 文档项目的内容，大篇幅地增补了理论、命令选项和历史部分，FreeBSD 文档项目的许可证参见 **COPYRIGHT** 文件。

**作为项目目标的一部分，我们会重写所有直接引用的相关章节，并规范化标注引用来源及作者。**

由于历史原因以及对开源许可证规范认识不足，可能仍然存在未按原作者要求注明来源及作者的现象。在此表示歉意。如果读者有任何疑问，请联系 `yklaxds@gmail.com`。

## 社区管理与技术维护人员

[超和平 Busters](https://github.com/banbo96)（QQ 昵称/微信名）对本社区及文档的管理，以及 QQ 群、微信公众号、微信群的运营，发挥了重要作用，并创建和维护过本社区的多个关联账号。
...
本项目的镜像网站 `docs.bsdcn.org` 基于 [VitePress](https://vitepress.dev/) 构建。

本项目的镜像网站 `doc.bsdcn.org` 已针对境内访问进行了优化。

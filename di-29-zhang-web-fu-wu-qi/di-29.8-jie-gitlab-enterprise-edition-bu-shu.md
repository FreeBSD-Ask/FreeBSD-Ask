...
GitLab 需使用 PostgreSQL 数据库。当前 GitLab 17.x 要求 PostgreSQL 最低版本为 14.14，GitLab 18.x 要求最低版本为 16.5（参见 GitLab. GitLab installation requirements — PostgreSQL[EB/OL]. [2026-04-16]. <https://docs.gitlab.com/ee/install/requirements.html>. 该页面列出了各版本 GitLab 对 PostgreSQL 的版本要求）。

...
NFS（Network File System，网络文件系统）最初由 Sun Microsystems 于 1984 年开发，是一种分布式文件系统协议，允许远程服务器共享其文件目录。
...
该记录表明问题原因在于 **/home/logs** 路径中存在软链接，因此无法共享。在 FreeBSD 中，**/home** 曾是 **/usr/home** 的软链接，与部分 Linux 发行版不同。

...
[qjail -- Utility for deployment of jail environments](https://www.freebsd.org/cgi/man.cgi?query=qjail&manpath=FreeBSD+15.0-RELEASE+and+Ports) 。官方手册提供完整命令参数说明，是 Qjail 使用的权威技术文档。

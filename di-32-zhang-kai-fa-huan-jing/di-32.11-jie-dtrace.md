...
DTrace 本身以通用开发与分发许可证（CDDL）发布。支持 DTrace 的 FreeBSD 内核本身采用 BSD 许可，但 DTrace 内核模块以二进制形式分发或加载时适用 CDDL（参见源代码文件 **sys/cddl/contrib/opensolaris/OPENSOLARIS.LICENSE**）。

...
DTrace 工具包使用 DTrace 特有的脚本语言 D 语言，其语法与 C++ 相似。本节不对 D 语言深入讲解。如需概览，请参阅 FreeBSD 的 d 手册页。D 语言在 [illumos 动态跟踪指南](https://www.illumos.org/books/dtrace/bookinfo.html) 中也有详细介绍。

...
> **注意**
>
> 上述错误信息中的 `libcrypto.so.111` 对应 OpenSSL 1.1.1（FreeBSD 13 及更早版本）。在 FreeBSD 14 及更高版本中，基本系统的 OpenSSL 已升级至 3.x，对应的库文件为 `libcrypto.so.30`，错误信息会有所不同，但根本原因相同：基本系统需要先更新。

...
dev.hdaa.0.nid29_config: 0x4024c601 as=0 seq=1 device=Headphones conn=None ctype=RCA loc=0x00 color=Res.C misc
=6
dev.hdaa.0.nid28_config: 0x411111f0 as=15 seq=0 device=Speaker conn=None ctype=1/8 loc=Rear color=Black misc=1
dev.hdaa.0.nid27_config: 0x02214010 as=1 seq=0 device=Headphones conn=Jack ctype=1/8 loc=Front color=Green mis
c=0
...
dev.hdaa.0.nid17_config: 0x40000000 as=0 seq=0 device=Line-out conn=None ctype=Unknown loc=0x00 color=Unknown 
misc=0
```

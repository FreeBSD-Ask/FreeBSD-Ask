...
Okular 是一款通用文档查看器，属于 KDE Plasma 项目的一部分，会随 KDE 桌面环境一道安装。Okular 支持多种文档格式，如 PDF、Postscript、DjVu、CHM、XPS、ePub 等。
...
Xpdf 是一款 PDF 查看器，适用于偏好轻量级应用的用户。当前 `graphics/xpdf` 已是 `graphics/xpdf4` 的 slave port，默认依赖 Qt5 工具包，不再是传统的纯 X11 轻量版本。

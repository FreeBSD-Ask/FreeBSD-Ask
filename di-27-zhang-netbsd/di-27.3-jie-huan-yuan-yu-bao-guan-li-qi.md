...
- [pkgsrc 镜像使用帮助](https://mirrors.tuna.tsinghua.edu.cn/help/pkgsrc/) ，换源方式，提供详细的国内镜像源配置指南
- [pkgsrc 与 IPS](https://nanxiao.me/pkgsrc-ang-ips/)，基本常识，对比分析 pkgsrc 与其他包管理系统
- [The pkgsrc-wip project](https://pkgsrc.org/wip) ，pkgsrc 官方使用说明，介绍工作中软件包的贡献流程
- [pkgsrc](https://www.pkgsrc.org/) ，官方安装说明，提供跨平台包管理系统的权威技术文档

...
NetBSD中不提供 xf86-video-vmware  xf86-input-vmmouse open-vm-kmod等组件，只安装open-vm-tools即可。
...
NetBSD中默认xorg配置有误，需手动生成配置文件后修改，以下步骤需在退出Xorg后操作：

开机不启动Xorg，在/etc/rc.conf中设置

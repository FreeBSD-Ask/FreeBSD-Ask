...
- HOWTO install the XFCE 4 Desktop on NetBSD 8.1[EB/OL]. [2026-03-25]. <https://slice2.com/2019/09/21/howto-install-the-xfce-4-desktop-on-netbsd-8-1/?amp=1>. 提供 Xfce 4 在 NetBSD 上的详细安装步骤
...
- 成功尝试在 NetBSD 9.0 中安装 Mate 桌面环境[EB/OL]. [2026-03-25]. <https://www.bilibili.com/read/cv17144331>. 记录 NetBSD 9.0 上 MATE 桌面环境的配置过程
...
由于 KDE 5 的原因，KDE 4 的中文语言包已被删除，详见 [NOTICE: This package has been removed from pkgsrc](https://pkgsrc.se/x11/kde4-l10n-zh_CN)。

### 参考文献

- NetBSD Wiki/GNOME[EB/OL]. [2026-03-25]. <https://wiki.netbsd.org/GNOME/>. 提供 NetBSD 上 GNOME 桌面环境的安装指南
- How can I start kde5 in netBSD9 ?[EB/OL]. [2026-03-25]. <https://www.unix.com/unix-for-beginners-questions-and-answers/283891-how-can-i-start-kde5-netbsd9.html>. 讨论 NetBSD 9 中 KDE 5 的启动配置
- Re: How to install KDE on NetBSD?[EB/OL]. [2026-03-25]. <https://www.mail-archive.com/netbsd-users@netbsd.org/msg13146.html>. 提供 KDE 在 NetBSD 上的安装方法

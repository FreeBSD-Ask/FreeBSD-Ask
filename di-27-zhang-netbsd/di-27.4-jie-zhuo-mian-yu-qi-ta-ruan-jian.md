...
NetBSD 可以使用常见的桌面环境，如 KDE 4、GNOME，并自带 Xorg（X Window System，X 窗口系统），因此无需单独安装。
...
Xfce 是一个轻量级的桌面环境，以下是安装步骤。安装 Xfce 桌面环境、FAM 文件监控服务、SLiM 登录管理器、中文字体以及 ee 文本编辑器：
...
MATE 是一个传统风格的桌面环境，以下是安装步骤。安装 MATE 桌面环境及其组件、SLiM 登录管理器、Marco 窗口管理器、FAM 文件监控服务、中文字体，以及 ee 文本编辑器：
...
安装 KDE 桌面环境、中文字体、Readline 库、CUPS（Common UNIX Printing System，通用 UNIX 打印系统）打印系统，以及 ee 文本编辑器：

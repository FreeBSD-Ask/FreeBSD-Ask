...
> **警告**
>
> 在 VB、VM 下目前无法正常进入桌面（UEFI），进去就黑屏，已经报告至 [NetBSD Problem Report #57554](https://gnats.netbsd.org/cgi-bin/query-pr-single.pl?number=57554) [备份](https://web.archive.org/web/20251207044854/https://gnats.netbsd.org/cgi-bin/query-pr-single.pl?number=57554)，如果读者知道原因欢迎告知。
...
由于 KDE5 的原因，KDE4 的中文语言包已被删除，详见 [NOTICE: This package has been removed from pkgsrc](https://pkgsrc.se/x11/kde4-l10n-zh_CN) [备份](https://web.archive.org/web/20250501030503/https://pkgsrc.se/x11/kde4-l10n-zh_CN)。
...
编辑 `/etc/X11/xorg.conf` 文件，修改以下段落（其他部分不需要动，保留原样即可）：

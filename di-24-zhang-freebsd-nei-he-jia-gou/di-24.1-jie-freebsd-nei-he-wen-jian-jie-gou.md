...
- `LINT-NOINET6`：LINT 文件，不到五行，禁用了 INET6(4)[EB/OL]. [2026-03-26]. <https://man.freebsd.org/cgi/man.cgi?query=inet6&sektion=4&man>（IPv6）。参见：Eliminate building LINT makefiles[EB/OL]. [2026-03-26]. <https://reviews.freebsd.org/D26540>

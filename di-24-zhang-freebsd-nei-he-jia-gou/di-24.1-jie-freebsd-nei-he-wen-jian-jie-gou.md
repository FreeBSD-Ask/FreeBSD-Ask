...
本节介绍 FreeBSD 操作系统内核的配置文件组织结构，从文件系统路径定位到具体配置指令语法，为内核定制和系统优化提供指导。
...
FreeBSD-CURRENT（main 分支）作为开发主线，其设计目标之一是构建强大的调试基础设施，以支撑内核与驱动程序的开发及测试工作。所有 main 主线上的 FreeBSD 系统（即 CURRENT）均默认启用调试功能，这对调试开发环境具有重要价值；需要注意的是，此配置会对系统性能产生显著影响。

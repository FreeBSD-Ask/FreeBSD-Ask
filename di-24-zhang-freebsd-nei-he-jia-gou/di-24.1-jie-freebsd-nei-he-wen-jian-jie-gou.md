...
- `GENERIC-KASAN`：调试开发用。用于内核地址清理器（Kernel Address Sanitizer，KASAN），参见：amd64: Add MD bits for KASAN[EB/OL]. [2026-03-26]. <https://reviews.freebsd.org/D29455>、kasan(9)[EB/OL]. [2026-03-26]. <https://man.freebsd.org/cgi/man.cgi?query=kasan&sektion=9&format=html>，不到十行

...
- OpenBSD. iwx(4) Device Drivers Manual[EB/OL]. [2026-04-16]. <https://man.openbsd.org/iwx>. OpenBSD iwx 驱动手册页，指出该驱动不支持 802.11ax 功能。
- OpenBSD. OpenBSD 7.8 Release[EB/OL]. (2025-10-22)[2026-04-16]. <https://www.openbsd.org/78.html>. OpenBSD 7.8 发行说明，DRM 同步至 Linux 6.12.50；
- OpenBSD. OpenBSD FAQ - Introduction to OpenBSD[EB/OL]. [2026-04-17]. <https://www.openbsd.org/faq/faq1.html>. OpenBSD 官方常见问题，明确记载默认 shell 为 ksh（基于 pdksh），而非 oksh。

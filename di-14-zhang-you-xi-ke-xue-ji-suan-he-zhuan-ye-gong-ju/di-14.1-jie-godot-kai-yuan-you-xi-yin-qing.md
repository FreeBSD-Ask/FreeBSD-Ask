...
导出游戏可执行文件：点击编辑器顶部菜单栏的“编辑器（Editor）”，然后选择“管理导出模板（Manage Export Templates）”。在弹出的面板中，直接点击对应当前版本的“下载并安装（Download and Install）”按钮。

![下载模板文件](../.gitbook/assets/pnggodot_game6.png)

...
本章介绍 FreeBSD 原生虚拟化技术 bhyve 的 Web 图形化管理工具 BVCP。bhyve 作为 FreeBSD 系统级虚拟化解决方案，提供 Type-2 hypervisor 功能，支持多种客户机操作系统。BVCP 则通过 Web 界面降低了 bhyve 的使用门槛，实现虚拟机的可视化管理。

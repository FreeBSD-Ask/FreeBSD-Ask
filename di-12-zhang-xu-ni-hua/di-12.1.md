...
本章介绍 FreeBSD 原生虚拟化技术 bhyve 的 Web 图形化管理工具 BVCP。bhyve 作为 FreeBSD 系统级虚拟化解决方案，提供二级虚拟机监控程序（Type-2 hypervisor）功能，支持多种客户机操作系统。BVCP 则通过 Web 界面降低了 bhyve 的使用门槛，实现虚拟机的可视化管理。


本文支持 FreeBSD 12 及更高版本，实验环境基于 FreeBSD 14.2 RELEASE。本文所使用的 BVCP 2.1.4 版本尚不支持中文本地化。

本软件尚未开源，其项目仓库地址为：<https://github.com/DaVieS007/bhyve-webadmin>

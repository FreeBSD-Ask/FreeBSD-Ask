...
本节将介绍如何在 BVCP 中安装 Ubuntu 24.04 系统。

下载 Ubuntu 24.04：从中国科学技术大学镜像站获取 Ubuntu 24.04 桌面版安装镜像

```sh
# fetch https://mirrors.ustc.edu.cn/ubuntu-releases/noble/ubuntu-24.04.1-desktop-amd64.iso
```

将镜像移动到 `iso_images`（安装中指定的路径）：将下载的 ISO 文件移动到 BVCP 配置的镜像存放目录，以便 Web 界面可以识别

```sh
# mv ubuntu-24.04.1-desktop-amd64.iso /vms/iso_images
```

完成准备工作后，即可通过 Web 界面开始创建虚拟机，具体操作步骤可参考以下截图：
...
本节介绍在 BVCP 中安装 Windows 11 的方法。详细步骤与前文 Ubuntu 24.04 的安装说明类似，可参见前一节"使用 bhyve 及 vm-bhyve 工具安装 Windows 11"，此处仅列出不同之处。
...
可参见官方文档 [Uninstallation of BVCP](https://bhyve.npulse.net/uninstall) [备份](https://web.archive.org/web/20260115040544/https://bhyve.npulse.net/uninstall) 进行卸载操作。

## 参考文献

- [bhyve を GUI で 操作 する BVCP の 導入。](https://running-dog.net/2024/02/post_2933.html) [备份](https://web.archive.org/web/20260114074842/https://running-dog.net/2024/02/post_2933.html)，提供 BVCP 安装与配置的实用指南
- [How to install BVCP](https://bhyve.npulse.net/installation) [备份](https://web.archive.org/web/20260115040607/https://bhyve.npulse.net/installation)，官方安装说明，详细指导 BVCP 部署流程
- [TroubleShoot / Frequently Asked Questions (FAQ)](https://bhyve.npulse.net/technical) [备份](https://web.archive.org/web/20260117041733/https://bhyve.npulse.net/technical)，常见疑难解答，提供故障排除方案
- [Deploy Virtual Machine (Windows)](https://bhyve.npulse.net/deploy_windows) [备份](https://web.archive.org/web/20260114170236/https://bhyve.npulse.net/deploy_windows)，官方 Windows 安装说明，详述 Windows 虚拟机部署

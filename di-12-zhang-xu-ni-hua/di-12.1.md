...
本章介绍 FreeBSD 原生虚拟化技术 bhyve（BSD Hypervisor）的 Web 图形化管理工具 BVCP。bhyve 作为 FreeBSD 系统级虚拟化解决方案，提供 Type-2 hypervisor 功能，支持多种客户机操作系统。BVCP 则通过 Web 界面降低了 bhyve 的使用门槛，实现虚拟机的可视化管理。
...
- [bhyve を GUI で 操作 する BVCP の 導入。](https://running-dog.net/2024/02/post_2933.html) [备份](https://web.archive.org/web/20260114074842/https://running-dog.net/2024/02/post_2933.html)
- [How to install BVCP](https://bhyve.npulse.net/installation) [备份](https://web.archive.org/web/20260115040607/https://bhyve.npulse.net/installation)，官方安装说明
- [TroubleShoot / Frequently Asked Questions (FAQ)](https://bhyve.npulse.net/technical) [备份](https://web.archive.org/web/20260117041733/https://bhyve.npulse.net/technical)，常见疑难解答
- [Deploy Virtual Machine (Windows)](https://bhyve.npulse.net/deploy_windows) [备份](https://web.archive.org/web/20260114170236/https://bhyve.npulse.net/deploy_windows)，官方 Windows 安装说明

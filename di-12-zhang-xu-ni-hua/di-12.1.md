...
如需卸载 BVCP，可参考官方文档 [Uninstallation of BVCP](https://bhyve.npulse.net/uninstall)  进行操作。

## 参考文献

- [bhyve を GUI で 操作 する BVCP の 導入。](https://running-dog.net/2024/02/post_2933.html) ，提供 BVCP 安装与配置的实用指南
- [How to install BVCP](https://bhyve.npulse.net/installation) ，官方安装说明，详细指导 BVCP 部署流程
- [TroubleShoot / Frequently Asked Questions (FAQ)](https://bhyve.npulse.net/technical) ，常见疑难解答，提供故障排除方案
- [Deploy Virtual Machine (Windows)](https://bhyve.npulse.net/deploy_windows) ，官方 Windows 安装说明，详述 Windows 虚拟机部署

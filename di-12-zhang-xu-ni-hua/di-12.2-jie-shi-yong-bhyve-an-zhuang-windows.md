...
- [vm-bhyve/wiki/Running-Windows](https://github.com/churchers/vm-bhyve/wiki/Running-Windows) ，教程主要参考此处，详述 Windows 虚拟机部署；中文版本在 [vm-bhyve Wiki](https://book.bsdcn.org/wen-zhang/wen-zhang/vm-bhyve) 
...
- [windows 11 on bhyve](https://forums.freebsd.org/threads/windows-11-on-bhyve.82371/) ，社区讨论 Windows 11 部署问题与解决方案
- [FreeBSD, bhyve и Windows 11](https://dadv.livejournal.com/209650.html) ，提供俄语 Windows 11 部署指南
- [iki/bhyve/Windows](https://wiki.freebsd.org/bhyve/Windows) ，官方 Wiki 提供 Windows 虚拟机支持信息
- [churchers/vm-bhyve/wiki](https://github.com/churchers/vm-bhyve/wiki) ，vm-bhyve 官方文档
- [Using Windows on FreeBSD's vm-bhyve](https://srobb.net/vm-bhyve.html) ，提供 Windows 虚拟机实用配置指南

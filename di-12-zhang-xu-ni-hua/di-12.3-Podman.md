...
- Josphat Mutai. Install Podman and run Containers in FreeBSD 14[EB/OL]. [2026-03-25]. <https://cloudspinx.com/install-podman-and-run-containers-in-freebsd/>. 提供 FreeBSD 14 上 Podman 实用配置指南

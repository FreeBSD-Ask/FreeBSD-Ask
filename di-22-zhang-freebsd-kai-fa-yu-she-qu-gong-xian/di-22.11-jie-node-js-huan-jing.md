...
在 FreeBSD 上配置 Node.js 环境前，我们需要先了解一些系统兼容性方面的注意事项。使用 pkg 安装的二进制 Node.js 依赖于特定版本的 `/lib/libcrypto.so.xxx` 文件，这意味着在 FreeBSD 上使用 Node.js 时，需要关注 FreeBSD 系统的版本，尤其是当你的 pkg 配置使用 latest 源时。

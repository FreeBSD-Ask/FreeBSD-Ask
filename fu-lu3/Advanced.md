...
本章节主要介绍 BIOS 中的高级设置选项，涵盖连接性配置、CPU 配置、电源与性能管理等方面。高级设置提供了对系统硬件性能、功耗管理和连接性参数的精细控制，这些选项通常涉及底层硬件操作，需要一定的技术背景。对于系统优化、故障排查和特定应用场景的适配，高级设置具有重要价值。
...
最高主频一般可通过官方 CPU 数据表查询，Intel 参见：产品规范[EB/OL]. [2026-03-26]. [2026-03-26]. <https://www.intel.cn/content/www/cn/zh/ark.html#@Processors>

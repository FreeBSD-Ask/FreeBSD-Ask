...
本章节主要介绍 BIOS 中芯片组相关的设置选项，包括系统代理配置、内存配置等内容。
...
内存 Bank 是电脑系统与内存之间数据总线的基本工作单位。参见 [什么是内存 BANK](https://iknow.lenovo.com.cn/spider/detail/kd/030022) [备份](https://web.archive.org/web/20260122124304/https://iknow.lenovo.com.cn/spider/detail/kd/030022)

...
作者及发布单位对本文档中包含的技术性或编辑性错误或遗漏不承担任何责任。本信息以"不附加任何保证"的方式提供，没有任何种类的担保。在法律允许的范围内，在任何情况下，作者及发布单位均不对偶然性、特殊性或继发性损失负责，包括停机成本、利润损失、因获取替代产品或服务而产生的损失，以及数据丢失或软件损坏。本文档包含的信息可能随时更改，恕不另行通知。本文中所涉及的其他产品和公司名称可能是其相应所有者的商标。使用前请做好数据备份，确保相关设置与设备兼容，并在受控环境中谨慎测试。

## 说明

本章相关内容可参考华硕. NUC BIOS 概述[EB/OL]. [2026-03-26]. <https://www.asus.com.cn/support/faq/1052524/>，该文档提供了 BIOS 配置的基础说明。

## 为什么选择 AMI BIOS

AMI BIOS 是美国安迈科技公司（American Megatrends Inc.，简称 AMI）开发的 BIOS 固件，广泛应用于个人计算机和服务器平台。

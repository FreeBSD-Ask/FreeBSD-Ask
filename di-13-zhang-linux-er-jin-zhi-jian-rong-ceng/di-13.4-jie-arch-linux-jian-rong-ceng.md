...
- FreeBSD Project. linux(4)[EB/OL]. [2026-03-25]. <https://man.freebsd.org/cgi/man.cgi?query=linux&sektion=4&manpath=FreeBSD+16.0-current>. 该文档详细介绍 FreeBSD Linux 兼容层的技术原理与配置方法。

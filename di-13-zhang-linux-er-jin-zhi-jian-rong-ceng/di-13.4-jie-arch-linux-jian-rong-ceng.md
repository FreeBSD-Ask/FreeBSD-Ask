...
echo ""
echo "For convenience, the following initial configuration can be performed:"     # 提示可进行初始化配置
echo "If you agree:"                                        # 提示用户选择
echo "   Set resolv.conf to Alibaba DNS"                  # 将 DNS 设置为阿里云公共 DNS
echo "   Initialize pacman keyring"                            # 初始化 pacman 密钥环
echo "   Configure Tsinghua mirror"                            # 使用清华镜像

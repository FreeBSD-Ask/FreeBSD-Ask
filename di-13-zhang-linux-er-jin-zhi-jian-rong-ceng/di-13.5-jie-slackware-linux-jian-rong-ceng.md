...
LinuxKernel=7.0.11
SUBDIR=""
BASE_URL="https://github.com/ykla/slackware-WSL/releases/download/auto-27"
...
case $ANSWER in
    [Aa][Ll][Ii]|[Aa]|"")
		...
		mkdir -p ${ROOT_DIR}/etc/resolv.conf
...
Slackware Linux 的大多数包管理器均不解决依赖问题，因此任何软件的安装都将面临着大量的依赖缺失。

如果需要任何依赖，可前往 <https://packages.slackware.com/> 查询：键入关键词，如“libgc.so.1”，Release 选择正确的版本，Mode 调整为“content”，即可得到搜索结果：“gc-8.0.6-x86_64-1.txz”，通常使用命令 `slackpkg install gc` 即可。

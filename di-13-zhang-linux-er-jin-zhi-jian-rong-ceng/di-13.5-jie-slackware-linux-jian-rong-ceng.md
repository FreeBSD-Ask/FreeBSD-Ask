...
LinuxKernel=7.0.11
SUBDIR=""
BASE_URL="https://ghproxy.net/https://github.com/ykla/slackware-WSL/releases/download/auto-26"
UPDATE_CMD="DIALOG=off BATCH=on slackpkg update && DIALOG=off BATCH=on slackpkg install-new"
UPGRADE_CMD="DIALOG=off BATCH=on slackpkg upgrade-all && DIALOG=off BATCH=on slackpkg clean-system"
UPDATE=1
UPGRADE=1
INSTALL=1

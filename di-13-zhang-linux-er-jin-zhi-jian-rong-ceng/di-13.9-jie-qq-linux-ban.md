...
- X.Org Foundation. xhost(1)[EB/OL]. [2026-04-17]. <https://man.freebsd.org/cgi/man.cgi?query=xhost&sektion=1&manpath=FreeBSD+16.0-current>. 说明了 X11 访问控制机制及 `xhost` 命令的使用方法。

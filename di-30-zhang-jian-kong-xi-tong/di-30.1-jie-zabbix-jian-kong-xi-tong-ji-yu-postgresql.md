...
上述安装过程将自动安装 PHP，本节安装的版本为 PHP 8.3。Zabbix 7.0.10 起亦正式支持 PHP 8.4，如需使用可改用 `zabbix7-frontend-php84` 及相应的 php84 扩展包。具体可用版本可查阅 [zabbix7-frontend](https://www.freshports.org/net-mgmt/zabbix7-frontend)，该站点提供最新的包信息与兼容性说明。

...
> **注意**
>
> InfluxDB OSS v1 主线仍处于维护状态，最新版本为 v1.12.x。FreeBSD Ports 中的 InfluxDB 仍为 v1.8.10，使用 v1 API 配置。生产环境亦可考虑使用 Port **net-mgmt/victoria-metrics** 替代时序数据库。

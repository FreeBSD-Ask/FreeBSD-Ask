...
- Raspberry Pi 4 に Arch Linux をインストール[EB/OL]. (2026-03-25)[2026-03-25]. <https://tonooo71.github.io/posts/archlinux-on-raspberrypi4>. 在树莓派 4 上安装 Arch Linux ARM 的详细教程。
- FreeBSD Handbook: Linux Binary Compatibility[EB/OL]. (2026-03-25)[2026-03-25]. <https://docs.freebsd.org/en/books/handbook/linuxemu/>. FreeBSD 官方 Linux 兼容层文档。

...
```sh
root@ykla:/home/ykla # kldload coretemp # 英特尔加载 coretemp，AMD 请参照参考文献
...
- 持久化温度设定（便于 htop 等软件使用），编辑 `/boot/loader.conf` 写入：
...
- [coretemp](https://man.freebsd.org/cgi/man.cgi?coretemp)，官方 man 手册

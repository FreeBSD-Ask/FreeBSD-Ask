...
- [Settings are not saved](https://github.com/htop-dev/htop/issues/949) 。讨论 htop 配置保存的常见问题与解决方案。
- [FreeBSD/ARM on the Raspberry Pi family](https://wiki.freebsd.org/arm/Raspberry%20Pi) 。FreeBSD 官方 wiki 关于树莓派 ARM 架构支持的详细文档。
- [Raspberry Pi 树莓派中文文档](https://rpicn.bsdcn.org) 。提供树莓派在 FreeBSD 上的安装、配置与使用指南。

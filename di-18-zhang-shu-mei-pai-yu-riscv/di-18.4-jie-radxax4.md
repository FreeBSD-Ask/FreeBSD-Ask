...
Radxa X4 是基于 x86 架构的开发板，搭载英特尔（Intel）N100 处理器。本节以 16G 内存和 128G eMMC 版本为基础进行介绍。
...
本节介绍如何查看系统实时状态。该命令每秒刷新一次虚拟内存及系统状态信息：
...
本附录介绍在 Windows Server 2025 上安装英特尔 i226-V 网卡驱动的方法。i226-V 在 Windows Server 下可使用 I226-LM 驱动（I226-LM 与 I226-V 功能相同），无需修改任何文件或系统配置：

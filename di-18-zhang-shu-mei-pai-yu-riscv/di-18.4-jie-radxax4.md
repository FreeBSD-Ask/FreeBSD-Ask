...
- coretemp[EB/OL]. (2026-03-25)[2026-03-25]. <https://man.freebsd.org/cgi/man.cgi?coretemp>. FreeBSD 官方 coretemp 模块 man 手册，用于 Intel 处理器温度监控。
- amdtemp[EB/OL]. (2026-03-25)[2026-03-25]. <https://man.freebsd.org/cgi/man.cgi?amdtemp>. FreeBSD 官方 amdtemp 模块 man 手册，用于 AMD 处理器温度监控。
- FreeBSD find CPU (processor) temperature command[EB/OL]. (2026-03-25)[2026-03-25]. <https://www.cyberciti.biz/faq/freebsd-determine-processor-cpu-temperature-command/>. 介绍了 FreeBSD 下读取 CPU 温度的方法与命令。
...
1. 首先下载并解压驱动 [适用于 Windows Server 2025* 的英特尔 ® 网络适配器驱动程序](https://www.intel.cn/content/www/cn/zh/download/838943/intel-network-adapter-driver-for-windows-server-2025.html)
2. 打开设备管理器，找到以太网控制器
3. 在其属性页面选择“更新驱动程序”
...
- 华硕主板板载 Intel i225-V 和 i226-V 网卡驱动在 Windows server 2019 下的安装[EB/OL]. (2026-03-25)[2026-03-25]. <https://zhuanlan.zhihu.com/p/624820359>. 详述了 Intel i225-V 和 i226-V 网卡在 Windows Server 环境下的驱动安装方法。

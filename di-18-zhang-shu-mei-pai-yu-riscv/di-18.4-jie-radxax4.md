...
- [coretemp](https://man.freebsd.org/cgi/man.cgi?coretemp)。FreeBSD 官方 coretemp 模块 man 手册，用于 Intel 处理器温度监控。
- [amdtemp](https://man.freebsd.org/cgi/man.cgi?amdtemp)。FreeBSD 官方 amdtemp 模块 man 手册，用于 AMD 处理器温度监控。
- [FreeBSD find CPU (processor) temperature command](https://www.cyberciti.biz/faq/freebsd-determine-processor-cpu-temperature-command/)。介绍 FreeBSD 下读取 CPU 温度的方法与命令。
...
- [华硕主板板载 Intel i225-V 和 i226-V 网卡驱动在 Windows server 2019 下的安装](https://zhuanlan.zhihu.com/p/624820359)。详细介绍 Intel i225-V 和 i226-V 网卡在 Windows Server 环境下的驱动安装方法。

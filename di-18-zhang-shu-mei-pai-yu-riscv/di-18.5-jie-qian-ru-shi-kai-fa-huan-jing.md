...
> **警告**
>
> ESP-IDF 官方尚不 FreeBSD，其官网文档也仅列出 Windows/Linux/macOS 的支持。
>
...
```sh
$ mkdir -p /path/to/new/project      # 创建文件夹来吃存储示例项目
$ cd /path/to/new/project    # 进入改目录 
...
[Arduino](https://www.arduino.cc/)（阿尔杜伊诺）是一个开源的电子原型平台，2005 年由意大利 Ivrea Interaction Design Institute 的学生和老师发起，目的是让非专业人士也能轻松做电子项目。
...
- [Arduin of Ivrea](https://www.britannica.com/biography/Arduin-of-Ivrea)，关于这位国外的有记载文献或许并不算多，大英百科全书中也只有寥寥数语

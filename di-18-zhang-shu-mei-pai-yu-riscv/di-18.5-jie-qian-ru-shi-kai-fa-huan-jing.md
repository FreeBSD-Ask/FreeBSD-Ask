...
[Arduino](https://www.arduino.cc/)（阿尔杜伊诺）是一个开源的电子原型平台，2005 年由意大利伊夫雷亚交互设计学院（Interaction Design Institute Ivrea, IDII）的学生和老师发起，最初目的是用于教学（交互设计硕士课程），让非专业人士也能轻松做电子项目。2006 年，面对缺乏资金的窘境，伊夫雷亚交互设计学院（2001-2006）停办。Arduino 的原型却被保留了下来……

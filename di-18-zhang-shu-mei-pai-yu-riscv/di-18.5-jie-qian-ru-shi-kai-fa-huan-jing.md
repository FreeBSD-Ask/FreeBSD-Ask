...
配置好兼容层后，到 [STM32CubeMX 官网](https://www.st.com/en/development-tools/stm32cubemx.html) [备份](https://web.archive.org/web/20250301000000/https://www.st.com/en/development-tools/stm32cubemx.html)下载最新压缩包后进行解压。写作本文时，下载无需注册登录，仅需点击以访客身份下载即可，按页面提示填入姓名、邮件地址等信息，注意下载链接会被发送到邮件中，请确保邮件地址可以收信。
...
- [Arduino，你的名字究竟该怎么读？](https://mp.weixin.qq.com/s/O4wfBF_WlHksmoWbMs7QeA)。Arduino 中国官方微信公众号文章，详细介绍 Arduino 名称的由来与正确发音。微信公众号运营主体为 Arduino 在中国的外企独资公司，法定代表人为创始人 Federico Musto 先生。
- [Arduin of Ivrea](https://www.britannica.com/biography/Arduin-of-Ivrea)。大英百科全书关于意大利国王阿尔杜因·德·伊夫雷亚的历史记载条目。

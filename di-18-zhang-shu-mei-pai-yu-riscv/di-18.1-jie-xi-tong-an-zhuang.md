...
- [Raspberry Pi 树莓派中文文档](https://rpicn.bsdcn.org) 。提供树莓派日常安装、配置与使用指南。
...
- [Default Setting for the UHSMODE?](https://forums.raspberrypi.com/viewtopic.php?t=75464) 。讨论树莓派 SD 卡 UHS 模式的默认配置与性能优化。
- [DataTraveler 100 G3 USB 3.0 Flash Drive - 技术支持](https://www.kingston.com/cn/support/technical/products/dt100g3) 。金士顿 DT100G3 U 盘的技术规格与支持文档。

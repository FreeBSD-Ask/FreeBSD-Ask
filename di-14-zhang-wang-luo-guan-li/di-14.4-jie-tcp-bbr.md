...
RACK（Recent ACKnowledgment）是 Netflix 开发的一种 TCP 栈，旨在通过改进丢包恢复机制优化网络传输性能。与传统基于 4.4BSD TCP 栈相比，RACK 在高延迟丢包恢复速度更快，在现代网络环境中具有更好的性能表现。

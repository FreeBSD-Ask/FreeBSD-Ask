# 25.6 在 Linux 系统上交叉构建 FreeBSD

本节介绍在 Linux 系统上交叉构建 FreeBSD 操作系统的步骤。交叉构建通过在主机构建系统上生成目标架构的可执行代码，实现开发环境与运行环境的解耦。
...
- FreeBSD Project. clang(1) -- the Clang C, C++, and Objective-C compiler[EB/OL]. [2026-04-17]. <https://man.freebsd.org/cgi/man.cgi?query=clang&sektion=1>. Clang 编译器手册页。

...
git 用的越久觉得傻逼的地方越多，设计就是弱智。我恐怕他自己也不知道设计的什么。和那套 gcc 语法一样弱智反人类。

...
Minecraft 对 JDK 版本有特定要求，不同游戏版本所需 Java 版本不同：1.17 需要 Java 16，1.18 至 1.20.4 需要 Java 17，1.20.5 及以上版本需要 Java 21。经测试，JDK 21 可正常运行最新版 Minecraft。
...
HMCL（Hello Minecraft! Launcher）是用 Java 开发的 Minecraft 启动器，支持多版本管理和模组加载。

...
illumos 版本 ZFS 的功能更新日趋减少（其开发主力仍为 OpenZFS），FreeBSD 对该版本 ZFS 的维护难度也不断上升。ZFS 的新功能通常需先合并到 illumos，再反向移植至 FreeBSD。但 illumos 的开发已基本停滞。2018 年 8 月，FreeBSD 项目开始研究如何将 FreeBSD ZFS 从 illumos 迁移至上流 OpenZFS。

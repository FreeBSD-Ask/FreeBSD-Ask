...
克隆的典型用途是保留快照的同时，对特定数据集进行实验，以便在出错时可以恢复。由于快照无法更改，可为其创建一个可读写的克隆。实验取得理想结果后，可将克隆提升为数据集，并删除初始的文件系统。删除原始数据集并非必要，因为克隆与数据集可以共存而不会引发问题。

```sh
# zfs clone zroot/home/ykla@test zroot/home/ykla2
root@ykla:/home/ykla # ls -al /home/ykla*
/home/ykla:
total 28222

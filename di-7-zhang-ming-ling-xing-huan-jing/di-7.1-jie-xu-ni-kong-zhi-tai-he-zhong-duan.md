...
FreeBSD 虚拟控制台布局
  ...
  快捷键     控制台     用途
  ────────────────────────────────────────────
  Alt+F1  →  ttyv0      系统控制台（系统消息）
  Alt+F2  →  ttyv1      虚拟控制台 1
  Alt+F3  →  ttyv2      虚拟控制台 2
  Alt+F4  →  ttyv3      虚拟控制台 3
  Alt+F5  →  ttyv4      虚拟控制台 4
  Alt+F6  →  ttyv5      虚拟控制台 5
  Alt+F7  →  ttyv6      虚拟控制台 6
  Alt+F8  →  ttyv7      虚拟控制台 7
  ────────────────────────────────────────────
  ttyv8 ~ ttyvf         未默认启用（/etc/ttys 配置）

  Xorg 环境下：
  Ctrl+Alt+F1 ~ F8  →  返回文本虚拟控制台
  Ctrl+Alt+F9        →  返回图形界面（通常）
```

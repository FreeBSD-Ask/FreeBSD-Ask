...
因为部分服务器未启用 DHCP 服务，所以可能需要手动配置 IP。

## 视频教程

[08-腾讯云轻量云与其他服务器安装 FreeBSD](https://www.bilibili.com/video/BV1y8411d7pp)
...
对于支持在线调整的文件系统，可压缩出约 2 GB 的未分配空间，创建一个 FAT32 分区，再将 img 镜像用 `dd` 写入该分区。

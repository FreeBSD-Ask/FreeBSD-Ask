...
- [Remote Installation of the FreeBSD Operating System Without a Remote Console](https://docs.freebsd.org/en/articles/remote-install/) ，FreeBSD 官方文档，详细介绍了无远程控制台情况下的远程安装技术。
- [GRUB2 配置文件“grub.cfg”详解（GRUB2 实战手册）](https://www.jinbuguo.com/linux/grub.cfg.html) ，作者：金步国。提供了 GRUB2 配置的详细参数解释与实战指南。下同。
- [关于启动时不显示 grub 界面的问题](https://phorum.vbird.org/viewtopic.php?f=2&t=40587) ，讨论了 GRUB 启动界面隐藏问题的解决方案。

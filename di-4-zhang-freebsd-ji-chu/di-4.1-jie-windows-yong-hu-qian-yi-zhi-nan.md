...
![文件系统基础](../.gitbook/assets/zhuzi-2.jpg)

![文件系统基础](../.gitbook/assets/zhuzi-3.jpg)
...
![文件系统基础](../.gitbook/assets/winfile.png)
...
![如何理解挂载](../.gitbook/assets/jiajie.png)

小时候住在花木场的人们都知道，经常需要从树 A 上剪裁一段枝条，将其斜插到树 B 上，并加以包裹，愈合后就会成为一体：比如在苹果树（UNIX）上可以长出桃子（挂载 Windows 的 `C` 盘）。
...
![非法字符](../.gitbook/assets/Windows1.png)
...
![大小写敏感](../.gitbook/assets/Windows3.png)

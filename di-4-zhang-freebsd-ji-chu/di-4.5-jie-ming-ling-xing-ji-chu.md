...
>**技巧**
>
>当使用上述命令关闭 FreeBSD 时，系统将调用 shell 脚本 `/etc/rc.shutdown`。该脚本依次调用每个 *rc.d* 脚本，将 rc 脚本列表逆序关闭系统服务。（参见 FreeBSD Project. rc.shutdown[EB/OL]. (2026-04-09)[2026-04-09]. <https://github.com/freebsd/freebsd-src/blob/main/libexec/rc/rc.shutdown>）

...
- [FreeBSD 7.0-RELEASE Announcement](https://www.freebsd.org/releases/7.0R/announce/) [备份](https://web.archive.org/web/20260121073655/https://www.freebsd.org/releases/7.0R/announce/)，官方公告明确 freebsd-update 为支持的二进制更新工具，适用于版本升级、安全修复及勘误补丁
...
当系统检测到引导加载程序版本过旧时，会显示类似下面的提示界面。

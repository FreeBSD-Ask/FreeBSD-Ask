...
- FreeBSD Project. boot0 MBR 引导代码[EB/OL]. [2026-04-28]. <https://github.com/freebsd/freebsd-src/blob/main/stand/i386/boot0/boot0.S>. 该文件包含 MBR 引导扇区的实现，末两字节为 0xAA55 签名。

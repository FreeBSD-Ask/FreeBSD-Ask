...
uv 是一款具备极高执行效率的 Python 包管理器与依赖解析器。
...
该指令将自动生成 **pyproject.toml** 文件，建立项目元数据规范。
...
删除相关文件即可销毁项目，如 **.venv**、**uv.lock**、**pyproject.toml** 和 **.python-version** 等。

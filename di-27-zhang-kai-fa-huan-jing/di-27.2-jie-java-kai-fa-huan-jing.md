...
```ini
export JAVA_HOME="/usr/local/openjdk25"          # 设置 JAVA_HOME 环境变量指向 OpenJDK 23 安装路径
...
Eclipse 平台是一款开放可扩展的 IDE，适用于各种用途。Eclipse 平台提供了构建和运行集成软件开发工具的基础模块和平台。Eclipse 平台允许工具开发者独立开发与他人工具集成的工具。
...
建议先点击界面底部的任意位置，再进行全选，否则可能导致界面卡顿。
...
将自动填充一些代码，点击顶栏的三角形运行代码：

![IntelliJ IDEA 新建项目](../.gitbook/assets/idea7.png)

可以在“设置”，“主题...”中修改主题：

![关于 IntelliJ IDEA](../.gitbook/assets/idea7.png)
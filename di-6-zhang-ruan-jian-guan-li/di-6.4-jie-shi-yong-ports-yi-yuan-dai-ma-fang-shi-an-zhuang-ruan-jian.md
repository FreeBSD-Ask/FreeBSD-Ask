...
- FreeBSD Project. portmaster -- manage your ports without external databases or languages[EB/OL]. [2026-03-25]. <https://man.freebsd.org/cgi/man.cgi?query=portmaster&sektion=8&manpath=freebsd-16.0-current>. 无需外部数据库的 Ports 管理工具完整说明。

...
目前已有部分高校开源社区提交了非官方镜像申请，部分仍在审核中，部分已关闭。
...
优先建议高校学生使用校内资源搭建，或者直接从 USTC 的 `rsync` 服务进行同步。建议同步前先咨询 USTCLUG，以免带来不必要的麻烦，联系方式：[lug@ustc.edu.cn](mailto:lug@ustc.edu.cn)。

...
环境准备完成后，安装 FreeBSD。下图是新建页面，选中“通过映像文件安装 Windows、Linux 或 macOS”，确认并继续。

![新建](../.gitbook/assets/parallels-1.png)

点击左下角处“没有指定源也继续”，确认并继续。
...
名称和位置，可以自定义调整相关设置。勾选“安装前设定”，确认并继续。
...
在顶部选中“硬件”，在左侧边栏选中“CD/DVD”，在右侧的“源”选中下载的 FreeBSD 镜像。
...
安装桌面环境后，桌面即可正常运行，但分辨率无法调整。

## CPU 使用率正常

手动安装 Port **sysutils/htop** 后观察 CPU 使用率，一切正常，无需任何调整。

...
FreeBSD 整体系统结构符合一般 Windows、安卓或 macOS 用户的直觉，其采用统一的系统管理方式。
...
>
>>归根结底，二者只是雇佣关系。职业道德，荣誉光环究竟是虚伪的面纱，还是人类文明不可或缺的自我欺骗。但若将一切拉平，反而有悖于常识。
>
> 你怎样理解？
...
这并非危言耸听，AUR 中确实曾[存在恶意软件包](https://www.linuxuprising.com/2018/07/malware-found-on-arch-user-repository.html?m=1)。

...
本章介绍在 FreeBSD 操作系统上部署 Apache Web 服务器的方法与实践。
...
1. 对 Apache 24 进行安全加固，使其适用于生产环境。总结并提交 PR 至本文。

2. 在 FreeBSD 中，基于 Apache 24 配置 HTTPS 支持，实现 SSL 自签名。

3. 在 FreeBSD 中，基于 Apache 24 部署 WordPress 或 Typecho。

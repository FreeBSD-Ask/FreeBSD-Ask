...
>
> 比如大多数小众品牌固态硬盘都不会支持 ASPM（Active State Power Management，活动状态电源管理）技术。此技术能在保证固态硬盘运行效率的情况下尽可能地对固态硬盘进行降温，在实际测试中可使硬盘温度降低约 20 ℃。而一些小众品牌固态硬盘，因为无法很好地适配，开启后就会掉盘，于是主动对该技术在固态硬盘的固件中予以关闭。
>
> 还有一些小众品牌固态硬盘仍在使用 NVMe 1.4 协议版本。甚至存在多块硬盘使用相同序列号的情况，而硬盘序列号的重要性不亚于网卡的 MAC 地址，原则上不应重复，否则可能导致系统无法正确识别多块硬盘。

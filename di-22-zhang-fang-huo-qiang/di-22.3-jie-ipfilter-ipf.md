...
这两条规则允许所有流量通过一个名为 **em1** 的受信任局域网接口：
...
block in quick on em0 from 192.168.0.0/16 to any    #RFC 1918 私有 IP
block in quick on em0 from 172.16.0.0/12 to any     #RFC 1918 私有 IP
block in quick on em0 from 10.0.0.0/8 to any        #RFC 1918 私有 IP
block in quick on em0 from 127.0.0.0/8 to any       #回环
block in quick on em0 from 0.0.0.0/8 to any         #本网络
block in quick on em0 from 169.254.0.0/16 to any    #链路本地（APIPA）
block in quick on em0 from 192.0.2.0/24 to any      #为文档保留
block in quick on em0 from 224.0.0.0/3 to any       #Class D 组播和 E 类保留

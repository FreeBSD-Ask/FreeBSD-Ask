...
在默认情况下，FreeBSD 支持 I²C 和 USB 触摸板。本章将介绍触摸板的相关配置方法。

## 触摸板

### 关闭触摸板

要关闭触摸板，首先需要查找触摸板的设备标识：
...
Apple Magic Trackpad（苹果妙控板）触摸板系列因压感带来的舒适操作体验而闻名。
...
如果你的 USB 键盘、鼠标或触摸板在 15.0 以下的旧版本中工作正常，但在更新到 15.0 后发生故障，可以参考下文：

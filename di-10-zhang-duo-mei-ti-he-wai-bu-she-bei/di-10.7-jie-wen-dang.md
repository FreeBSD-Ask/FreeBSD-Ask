...
![Calibre 界面](../.gitbook/assets/okular-djvu.png)

## Evince

Evince 是一款支持多种文档格式（如 PDF 和 Postscript）的文档查看器，属于 GNOME 项目的一部分，会随 GNOME 桌面环境一道安装。
...
![Evince 界面](../.gitbook/assets/epdfview-pdf.png)

## ePDFView

ePDFView 是一款轻量级的 PDF 文档查看器，仅使用 Gtk+ 和 Poppler 库。ePDFView 的目标是提供简单的 PDF 文档查看器，类似于 Evince，但不使用 GNOME 库。操作比较简洁，待改进空间较大。
...
Zathura 是一款高度可定制且功能强大的文档查看器。它提供简约、节省空间的界面，主要专注于键盘交互，使用体验可改进空间较大。

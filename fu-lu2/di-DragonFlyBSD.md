...
完成初始引导后，我们需要进行硬盘写入和引导配置。本文基于 UEFI，我们选择 `UEFI`。新电脑（2016+）都应选择 UEFI。UEFI 是统一可扩展固件接口，是传统 BIOS 的替代方案，提供了更现代的启动机制。
...
![一些警告信息](../.gitbook/assets/dragonflybsd11.png)  

`Begin Installing Files`（开始安装文件）。

![开始解压缩安装文件](../.gitbook/assets/dragonflybsd12.png)  

正在解压缩文件到硬盘：

![正在解压缩文件到硬盘](../.gitbook/assets/dragonflybsd13.png)

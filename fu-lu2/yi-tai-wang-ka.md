...
网络适配器是计算机连接网络的重要硬件设备，FreeBSD 对多种网络适配器提供了支持。下面介绍 FreeBSD 兼容的网络适配器相关信息。
...
Realtek RTL8125 是一款常见的 2.5 G 以太网卡。在消费级市场中，常见的 2.5 G 网卡多采用该型号芯片。可以在 Windows 设备管理器中查看硬件标识，以下示例显示的即为该型号网卡：

...
目前，大多数将 Linux 用作专用设备操作系统，或基于其他 GPL 软件构建商业产品的公司，并未严格遵守 GPL 协议发布其修改后的代码。对于国内企业而言，其甚至不了解 GPL 的含义，仅将"免费"视为唯一考量。那些为逃避 GPL 强制开源规定而采取规避措施的企业产品，缺乏可信度与使用价值。抢注开源软件商标的事情亦时有发生。相较而言，那些使用 FreeBSD 的公司至少更为诚实、可靠和值得信赖，也真正使得 BSD 的代码为众人所用。纵然有人认为 FreeBSD 已趋衰落，事实上，这些用户可能始终受益于 FreeBSD 技术的支撑。

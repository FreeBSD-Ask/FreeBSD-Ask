...
目前，大多数将 Linux 用作专用设备操作系统，或基于其他 GPL 软件构建商业产品的公司，并未严格遵守 GPL 协议发布其修改后的代码。对于国内公司来说，他们甚至不知 GPL 为何物，只认为免费就可以了。那些为逃避 GPL 强制开源规定而采取规避措施的企业产品，缺乏可信度与使用价值。抢注开源软件商标的事情亦时有发生。比较起来，那些使用 FreeBSD 的公司至少更为诚实、可靠和值得信赖，也真正使得 BSD 的代码为众人所用。就算有人认为 FreeBSD 已日薄西山，事实上，这些人可能一直生活在 FreeBSD 技术的光辉之下。

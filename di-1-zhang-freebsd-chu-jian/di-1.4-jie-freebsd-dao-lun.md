...
使用 -CURRENT 的用户应要跟踪 FreeBSD-CURRENT：
...
由于更多用户运行 FreeBSD-STABLE 而非 FreeBSD-CURRENT，某些在 FreeBSD-CURRENT 中未发现的 bug 和边缘情况会在 FreeBSD-STABLE 中暴露。因此，不能盲目地跟踪 FreeBSD-STABLE。

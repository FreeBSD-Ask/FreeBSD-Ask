...
GNOME、Xorg（X11）、D-Bus、systemd、PulseAudio、Wayland、PipeWire 等主流 Linux 项目实际上受到红帽公司（Red Hat）的显著影响，而且它们大多难以完全适配其他类 UNIX 操作系统。
...
Alpha-Omega 项目先后对 FreeBSD 的 bhyve 虚拟机监视器、Capsicum 沙箱框架以及基本系统中的第三方程序进行了安全审计，旨在提升 FreeBSD 项目的安全性与合规性。

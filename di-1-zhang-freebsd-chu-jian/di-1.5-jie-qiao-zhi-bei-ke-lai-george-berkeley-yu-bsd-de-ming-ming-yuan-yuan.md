...
BSD（Berkeley Software Distribution，伯克利软件发行版）的命名源于其发源地——美国加州大学伯克利分校（University of California, Berkeley）。BSD 是加州大学伯克利分校计算机系统研究小组（Computer Systems Research Group，CSRG）对其在 AT&T 32V UNIX 基础上所做改进与扩展的统称，FreeBSD 即为 CSRG 工作的衍生成果。

加州大学伯克利分校及其所在城市伯克利市（Berkeley）的名称，均来自爱尔兰近代经验论哲学家乔治·贝克莱（George Berkeley，1685—1753）。在许多著作与文献中，他常被称为克洛因主教（Bishop of Cloyne）或贝克莱主教。

“Berkeley”在中文音译上存在不同写法，其美式与英式发音也不同（英 /ˈbɑːkli, ˈbəːkli/ 美 /ˈbɚkli/），但英文拼写保持一致。

受历史因素（如贝克莱曾购买黑奴引发的争议）及翻译习惯（历史上曾译作“巴克莱”等）的影响，这一关联在汉语世界与英语世界均不广为人知。
...
贝克莱不仅在哲学领域影响深远，其对微积分基础的批判亦构成数学史上的重要篇章。贝克莱的著作引发了关于无穷小量的数学哲学讨论（即贝克莱悖论，参见其 1734 年发表的《分析学家；或一篇致一位不信神数学家的论文，其中审查一下近代分析学的对象、原则及论断是不是比宗教的神秘、信仰的要点有更清晰的表达，或更明显的推理》）。
...
贝克莱的思想不仅影响了哲学和数学，也对现代科学产生了间接影响。贝克莱主教以其形而上学思想，特别是对牛顿绝对时空观的批判，启发了包括爱因斯坦在内的众多 20 世纪科学家。爱因斯坦认为时间并非绝对，而是与观察者的运动状态密切相关。
...
当代现象学与贝克莱哲学存在相通之处：两者均强调直接经验与知觉的首要性。
...
他还主张通过教育、培训，依靠民众来发展经济。他认为应该通过开展大型工程建设来缓解贫困问题。

贝克莱主张各宗教团体放下纷争，为共同利益而团结。在他淡出公众视野后，专注于为当地民众（无论天主教徒还是新教徒）兴办公益事业。

贝克莱的思想在其有生之年未被广泛接受，但在其后数百年间产生了深远的影响。
...
20 世纪 70 年代，加州大学伯克利分校的计算机科学研究人员开始修改与扩展 AT&T 贝尔实验室开发的 UNIX 操作系统。由于这些修改与扩展最初以软件发行包的形式发布，故称伯克利软件发行版（Berkeley Software Distribution，BSD）。

...
>
>所以看似是 Android 和 iOS 之争，其实是 Linux 与 BSD 之争。~~这也许还是大教堂与市集之争。~~
...
最终 Multics 的开发陷入了困境，Multics 设计了大量的程序及功能，经常融入许多矛盾的组件，导致系统过于复杂。1969 年，在贝尔实验室看来，作为一套信息处理工具，Multics 已无法实现为实验室提供计算服务的目标，设计太昂贵了。于是，在同年 4 月，贝尔实验室退出了 Multics 项目，只剩麻省理工学院和美国通用电气公司继续开发。

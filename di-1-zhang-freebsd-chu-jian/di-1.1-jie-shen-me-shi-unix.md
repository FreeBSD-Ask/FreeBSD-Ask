...
他需要编写三个程序，每周编写一个：创建代码的编辑器、将代码转换为 PDP-7 能运行的机器语言的汇编器，以及“内核的外层——操作系统”即告完成。

新的 PDP-7 操作系统开发不久后，Thompson 与几位同事进行讨论，当时系统尚未命名，最初称为“UnICS”（**非复用** 信息和计算服务，Uniplexed Information and Computing Service），后改为 UNIX，更易于记忆。

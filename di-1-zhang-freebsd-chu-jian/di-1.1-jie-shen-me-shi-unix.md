...
Multics 旨在创造功能强大的新软件，以及比肩 IBM 7094 功能更丰富的新硬件。1965 年，通用电气公司（General Electric，GE）与贝尔实验室加入该项目，形成三方合作。其中，通用电气公司负责设计及生产具备全新硬件特性、以更好地支撑分时及多用户体系的计算机；贝尔实验室在计算机发展早期就开发了自己的操作系统，具备相关经验。

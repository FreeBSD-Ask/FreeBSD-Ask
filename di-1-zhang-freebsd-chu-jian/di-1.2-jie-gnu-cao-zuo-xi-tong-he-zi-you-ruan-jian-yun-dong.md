...
UNIX 在后期发展中逐渐趋于封闭，从最初开放的研究项目（受当时美国法律要求）转变为商业产品。普通用户无法自由获取和修改其源代码，许可证价格高昂且使用权受到商业公司严格限制。理查德·马修·斯托曼（Richard Matthew Stallman，RMS）希望创造一款自由且与 UNIX 兼容的操作系统，这一愿景直接推动了自由软件运动的兴起。

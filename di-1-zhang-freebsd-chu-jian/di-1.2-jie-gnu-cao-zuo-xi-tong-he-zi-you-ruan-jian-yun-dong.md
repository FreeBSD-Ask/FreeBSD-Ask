...
基于对各类许可证及其评论的分析，上述协议限制了商业用户的使用，剥夺了商业用户的“自由”，因此知识共享署名-非商业性使用协议（Creative Commons Attribution-NonCommercial，CC-BY-NC）与知识共享署名-禁止演绎协议（Creative Commons Attribution-NoDerivs，CC-BY-ND）等均不属于开源软件许可证或自由软件许可证。原因在于，上述协议限制了商业用户的使用，剥夺了商业用户的“自由”。前述 CC 协议也不符合自由软件精神，其要求的冗长署名与声明增加了项目复用时的合规成本。

...
- FreeBSD Project. drm-kmod: drm driver for FreeBSD[EB/OL]. [2026-06-05]. <https://github.com/freebsd/drm-kmod/pulls>. 该仓库提供 FreeBSD 图形驱动程序内核模块更新，追踪 Linux DRM 驱动程序移植进度。 
...
**读者应优先使用 Rufus；仅在 Rufus 无效的情况下，方可考虑使用 win32diskimager 或 Ventoy。**

...
> **警告**
>
> 由于 FreeBSD 源代码默认假设将通过 DHCP 获取主机名，如果不设置主机名，系统不会自动分配任何值（包括“Amnesiac”），故官方手册中关于“Amnesiac”的说法存在偏差。根据当前源代码逻辑，使用 DHCP 时不会有空主机名提示；仅当无网络连接时，登录信息中才会显示“Amnesiac”并伴随一条错误提示。

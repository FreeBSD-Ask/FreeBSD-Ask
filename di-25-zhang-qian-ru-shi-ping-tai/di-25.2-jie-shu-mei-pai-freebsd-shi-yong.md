...
1. 在树莓派 5 上配置 FreeBSD 的 CPU 频率调节与电源管理，测试不同策略下的功耗与温度。
2. 在树莓派 5 上设计基准测试，对比 FreeBSD 原生 ARM64 与 Linux 兼容层的系统调用延迟与 I/O 吞吐量。
3. 分析 Broadcom SoC 的封闭性对 FreeBSD/ARM 生态的制约。

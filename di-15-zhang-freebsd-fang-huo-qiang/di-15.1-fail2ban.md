...
根据 [官方说明](https://github.com/fail2ban/fail2ban) [备份](https://web.archive.org/web/20260115042904/https://github.com/fail2ban/fail2ban)，Fail2Ban 可封禁多次身份验证错误的主机，[即通过更新系统防火墙规则来拒绝来自那些 IP 地址的新连接](https://github.com/fail2ban/fail2ban/wiki/How-fail2ban-works) [备份](https://web.archive.org/web/20260115140517/https://github.com/fail2ban/fail2ban/wiki/How-fail2ban-works)。Fail2Ban 几乎完全由 Python 写就（Python 占比约 96%）。本文适配了 FreeBSD 中常见的三种防火墙——IPFW、PF、IPF，读者无需同时配置以上所有防火墙，只需选择其中一款即可。

本文适配了 FreeBSD 中常见的三种防火墙——IPFW、PF、IPF，读者无需同时配置以上所有防火墙，只需选择其中一款即可。
...
安装完成后，需启用服务以实现开机自动启动，使 Fail2Ban 能够在系统启动后自动开始工作。
...
- [man ipfw(8)](https://man.freebsd.org/cgi/man.cgi?ipfw(8))，FreeBSD 官方防火墙管理工具参考手册，提供 IPFW 完整命令说明
- [fail2ban](https://dapeng.li/learning/fail2ban/d4.html) [备份](https://web.archive.org/web/20260115043130/https://dapeng.li/learning/fail2ban/d4.html)，本节架构基于此，提供 Fail2Ban 与 FreeBSD 集成方案
...
- [fail2ban does not feed pf table](https://forums.freebsd.org/threads/fail2ban-does-not-feed-pf-table.67798/) [备份](https://web.archive.org/web/20260115140500/https://forums.freebsd.org/threads/fail2ban-does-not-feed-pf-table.67798/)，FreeBSD 社区论坛讨论 Fail2Ban 与 PF 集成问题
- [Fail2ban on FreeBSD drops complete pf firewall rules](https://github.com/fail2ban/fail2ban/issues/1915) [备份](https://web.archive.org/web/20260115140601/https://github.com/fail2ban/fail2ban/issues/1915)，GitHub Issue 记录 Fail2Ban 与 PF 规则冲突问题

...
根据 [官方说明](https://github.com/fail2ban/fail2ban)，Fail2Ban 可封禁多次身份验证错误的主机，[即通过更新系统防火墙规则来拒绝来自那些 IP 地址的新连接](https://github.com/fail2ban/fail2ban/wiki/How-fail2ban-works)。Fail2Ban 几乎完全由 Python 写就（Python 占比约 96%）。本文适配了 FreeBSD 中常见的三种防火墙——IPFW、PF、IPF，你无需同时配置以上所有防火墙，只需选择其中一款即可。

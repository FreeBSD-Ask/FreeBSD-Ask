...
**学术引言增补**：在网络安全实践中，暴力破解（brute-force attack）是针对身份认证系统的常见威胁向量。Fail2Ban 作为一种基于日志的入侵防御系统（Intrusion Prevention System, IPS），通过动态更新防火墙规则来实现自适应访问控制，为服务器提供实时防护。
...
- [fail2ban](https://dapeng.li/learning/fail2ban/d4.html) [备份](https://web.archive.org/web/20260115043130/https://dapeng.li/learning/fail2ban/d4.html)，本节架构基于此
...
- [fail2ban does not feed pf table](https://forums.freebsd.org/threads/fail2ban-does-not-feed-pf-table.67798/) [备份](https://web.archive.org/web/20260115140500/https://forums.freebsd.org/threads/fail2ban-does-not-feed-pf-table.67798/)
- [Fail2ban on FreeBSD drops complete pf firewall rules](https://github.com/fail2ban/fail2ban/issues/1915) [备份](https://web.archive.org/web/20260115140601/https://github.com/fail2ban/fail2ban/issues/1915)

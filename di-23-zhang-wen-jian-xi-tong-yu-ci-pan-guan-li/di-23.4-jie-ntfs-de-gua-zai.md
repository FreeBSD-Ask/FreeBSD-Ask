...
- [NTFS on FreeBSD](https://www.gridbugs.org/ntfs-on-freebsd/) ，系统阐述了 NTFS 文件系统在 FreeBSD 上的挂载技术实现方案
...
- [ntfs-3g manpage](https://www.freebsd.org/cgi/man.cgi?query=ntfs-3g&format=html) （ntfs-3g 官方技术文档，详细说明各项参数配置与使用方法）

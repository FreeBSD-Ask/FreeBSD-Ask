...
>1.解释为什么二者存在冲突？
>
>2.如果仅从许可来看，自由软件基金会称任何树外模块都是不合规的，Ubuntu ZFS 模块即是一例。那么，这是都能反证整个 Linux 内核都是以 GPLv2 授权的？

>**思考题**
>
>1.为什么自由软件基金会称 BSD 2 条款许可证和 GPLv2/GPLv3 兼容？如果 BSD 授权的软件 A 进入 GPLv2 项目 B 中成为其一部分。下游用户再分发时，在何种条件下，要求软件 A 也遵守 GPLv2 而非通过 BSD 协议转为专有软件？
>

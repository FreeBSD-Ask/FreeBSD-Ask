...
在 OpenSolaris 关停 3 年后（2013），ZFS 的主要开发者迁移到了 ZFSonLinux，后重命名成为如今的 OpenZFS。OpenZFS 旨在统一 ZFS 的开源开发。由于 Oracle Solaris ZFS 的闭源开发，OpenZFS 很难再兼容 Oracle Solaris ZFS。

...
- [mount linux ext4 drives on Freebsd](https://forums.freebsd.org/threads/mount-linux-ext4-drives-on-freebsd.74414/) （FreeBSD 论坛讨论文章，详述 fusefs-ext2 在 FreeBSD 上挂载 EXT4 文件系统的实践方案）
- [XFS support](https://forums.freebsd.org/threads/xfs-support.61449/) （FreeBSD 论坛 XFS 支持讨论，探讨 XFS 文件系统在 FreeBSD 上的兼容性与挂载方法）

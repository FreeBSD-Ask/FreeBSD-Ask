...
GNOME 是一款用户友好的桌面环境。它包括用于启动应用和显示状态的面板、桌面、本地工具和应用程序，以及一套使应用程序易于协作并保持一致的设计规范。
...
[TopIcons Plus](https://extensions.gnome.org/extension/1031/topicons/) 已长期未更新，故只能使用 [AppIndicator and KStatusNotifierItem Support](https://extensions.gnome.org/extension/615/appindicator-support/)。

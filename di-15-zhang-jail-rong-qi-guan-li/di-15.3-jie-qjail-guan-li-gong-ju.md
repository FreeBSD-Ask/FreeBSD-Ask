...
ifconfig_lo1_alias0="inet 192.168.1.1-9" # 创建独立网段，共 9 个 IP 可供分配。请根据实际网络环境调整地址范围
```
...
以下命令均在 Jail 控制台下运行，pkg 安装时是否使用镜像请根据需要选择，若使用镜像可在 Jail 控制台中以与宿主机相同的方式进行设置，请参考相关文章。

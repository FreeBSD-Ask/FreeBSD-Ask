...
判断该问题是否属于缺陷（bug）。若问题可表述为疑问句（例如"如何操作……""何处可找到……"），宜先通过 FreeBSD 邮件列表咨询。

如果确认这是缺陷（bug），请核实系统版本是否仍受支持，否则可能无人受理。
...
- 对于无人维护的软件，若无补丁，仅报告缺陷可能无法获得处理；若有意维护该软件，请提交相关请求；
- 若问题无法复现，他人亦难以解决；
...
FreeBSD 开发人员有限，缺陷报告可能长时间无人处理。报告接收者大多是志愿者，故不宜苛求。如果可能，请先自行解决问题，再提交到上游。

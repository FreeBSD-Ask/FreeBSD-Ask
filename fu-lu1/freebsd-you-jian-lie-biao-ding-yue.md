...
应使用英语撰写；若不熟悉，可借助 [https://deepl.com](https://deepl.com) 翻译。遇到问题时，建议先通过邮件咨询，再提交 Bug 报告，以避免重复。

保持关注，如有人要求提供更多信息，请及时回复并耐心等待。
...
向该行列出的邮箱地址发送邮件，邮件主题无特定要求。用户将收到一封回信，其中提供了另一个邮箱地址，需再次向该地址发送邮件确认，邮件主题同样无特定要求。

完成以上步骤即可加入邮件列表。若发送邮件后未收到回复，请手动向 subscribe 所示的邮箱发送邮件，邮件主题和内容无特定要求。
...
这并不是一份禁止行为的详尽清单。请将其理解为一种指导原则，旨在让我们更方便地交流和参与社区活动。

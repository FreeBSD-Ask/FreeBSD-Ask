...
- 绿联 HDMI 延长器（单网线传输）[EB/OL]. 北京: 京东, 2026-04-19[2026-04-19]. <https://item.jd.com/100053619301.html>.
- CN101572074A. 将 HDMI 信号通过单条网线传输的方法[P]. 中国: 国家知识产权局, 2009-11-04.
...
microSD 通常也称为 TF 卡（TF 是 SanDisk 最初的商品名 TransFlash，后被 SD 协会采纳并更名为 microSD，二者是完全相同的物理产品），亦常被称作手机存储卡。

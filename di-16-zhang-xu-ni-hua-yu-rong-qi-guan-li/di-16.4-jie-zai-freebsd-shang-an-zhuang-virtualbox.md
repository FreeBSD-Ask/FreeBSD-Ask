...
- Oracle Corporation. GPL[EB/OL]. (2022-10-10)[2026-04-17]. <https://www.virtualbox.org/wiki/GPL>. 从 4.0 版本到 6.1 版本（含），VirtualBox 基础包根据 GPL V2 授权分发。（VirtualBox 的某些部分，尤其是库，也可能以其他许可证发布。）
- Oracle Corporation. GPLv3[EB/OL]. (2022-10-10)[2026-04-17]. <https://www.virtualbox.org/wiki/GPLv3>. 从 7.0 版本开始，VirtualBox 基础包根据 GPL V3 许可证进行许可。由于 Qt 库更改了其许可证，因此需要进行许可证变更以保持兼容性。

...
| 封面 | 书名 | 作者 | ISBN | 出版社 |
| :---: | :---: | :---: | :---: | :---: |
| ![UNIX 传奇：历史与回忆](../.gitbook/assets/unixchuanqi.png) | 《UNIX 传奇——历史与回忆》 | Brian W Kernighan | 9787115557179 | 人民邮电出版社 |  

《UNIX 传奇——历史与回忆》主要讲解了 UNIX 的发展历史。写的比较粗略。

| 封面 | 书名 | 作者 | ISBN | 出版社 |
| :---: | :---: | :---: | :---: | :---: |
| ![UNIX 编程艺术](../.gitbook/assets/s11345267.png) | 《UNIX 编程艺术》（TAOUP） | Eric Raymond | 9787121176654 | 电子工业出版社 |
...
|封面 | 书名 | 作者 | ISBN | 出版社 |
| :---: | :---: | :---: | :---: | :---: |
| ![Absolute FreeBSD, 3rd Edition: The Complete Guide to FreeBSD](../.gitbook/assets/AbsoluteBSD.png) | ***Absolute FreeBSD 3rd*** | Michael W. Lucas | 9781593278922 | No Starch Press |见下 |

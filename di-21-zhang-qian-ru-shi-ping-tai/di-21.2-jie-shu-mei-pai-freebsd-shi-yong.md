...
树莓派 5 之前的所有型号均未配备板载实时时钟（Real Time Clock，RTC）硬件模块，因此系统时间的维持完全依赖网络时间协议（Network Time Protocol，NTP）服务进行网络校时。树莓派 5 是该系列首款内置 RTC 模块的型号，可通过板载 J5 电池接口外接电池，在断电后维持时钟运行。

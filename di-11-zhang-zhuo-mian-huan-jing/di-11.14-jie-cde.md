...
CDE（Common Desktop Environment，通用桌面环境）是一款具有悠久历史的桌面环境，曾广泛应用于 UNIX 商业发行版。

CDE 是 20 世纪 90 年代商业 UNIX 系统的标准桌面环境。

...
| Code-OSS 可用（开源部分） | Code-OSS 不可用（闭源部分） |
| --- | --- |
| MIT 许可证 | 远程开发/同步设置 |
| clangd 插件 ✓ | 遥测功能 |
| Python 插件 ✓ | 扩展市场等专有服务 |
...
│                      C/C++ 构建方案对比                           │
├──────────────┬──────────────────┬───────────────────────────────┤
│   直接编译    │   CMake + Ninja  │       Meson + Ninja           │
├──────────────┼──────────────────┼───────────────────────────────┤
│ clang/gcc    │ CMakeLists.txt   │     meson.build                │
│    │         │      │           │        │                       │
│    ▼         │      ▼           │        ▼                       │
│  源文件      │  cmake 配置      │    meson setup                 │
│    │         │      │           │        │                       │
│    ▼         │      ▼           │        ▼                       │
│  可执行文件   │  ninja 构建      │    ninja 构建                  │
│              │      │           │        │                       │
│              │      ▼           │        ▼                       │
│              │  可执行文件       │    可执行文件                  │
├──────────────┼──────────────────┼───────────────────────────────┤
│ 适合单文件    │ 适合中大型项目    │ 语法简洁，构建速度快            │
│ 简单项目      │ 生态成熟          │ 适合现代项目                   │
└──────────────┴──────────────────┴───────────────────────────────┘
```

...
- 微软. Code pages[EB/OL]. [2026-03-26]. <https://learn.microsoft.com/en-us/globalization/encoding/code-pages>. 微软官方称，936 即是 GBK，用于中文简体字符编码；代码页 936 最初覆盖 GB 2312 字符集，后扩展为 GBK。严格来说，CP936 与 GBK 存在细微差异：CP936 在 GBK 基础上增加了 Euro 符号（U+20AC → 0x80）及 95 个 PUA（Private Use Area）字符映射，二者并非完全等同。

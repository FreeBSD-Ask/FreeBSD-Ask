...
> **警告**
>
> **MySQL 5.x 系列已停止官方维护，使用该版本需自行承担安全与兼容性风险。**
...
1. 在最新 FreeBSD RELEASE 中获取 MySQL 5.7 的 Ports 源代码，构建 MySQL 5.7 并在 QEMU 中启动验证。
2. 为 MySQL 5.7 配置 SSL/TLS 加密连接，测试客户端安全连接。
3. 分析在受安全更新的操作系统上运行已终止支持的数据库软件所面临的合规风险。

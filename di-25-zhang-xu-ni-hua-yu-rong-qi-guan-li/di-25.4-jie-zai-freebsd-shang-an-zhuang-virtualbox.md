...
自 4.0 起，VirtualBox 只有开源版本（4.0 至 6.1 称 Open Source Edition，7.0 起基础包直接以 GPLv3 发布），其余组件以闭源扩展包（VirtualBox Extension Pack）的形式单独提供，**尚不支持** FreeBSD：该扩展包提供 USB 2.0/3.0 主机控制器支持等附加功能（注：自 7.2 起，VRDP 服务器、磁盘与虚拟机加密、USB 智能卡模拟及 USB 摄像头等功能已移入开源基础包）。
...
- Oracle. Oracle VM VirtualBox Extension Pack[EB/OL]. [2026-04-17]. <https://docs.oracle.com/en/virtualization/virtualbox/7.0/user/Introduction.html>. 扩展包提供 USB 2.0/3.0 主机控制器支持等功能（注：自 7.2 起，VRDP、磁盘与虚拟机加密、USB 智能卡模拟及 USB 摄像头已移入开源基础包）。

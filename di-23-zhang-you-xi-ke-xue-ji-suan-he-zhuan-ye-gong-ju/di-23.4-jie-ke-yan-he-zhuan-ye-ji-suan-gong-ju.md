...
上一节使用 GLPK 求解线性规划问题，本节使用功能更强大的 wxMaxima 来求解。wxMaxima 不仅可进行数值计算，还支持符号运算与公式推导。以下代码仅供参考，如需深入了解可查看 [官方文档](https://maxima.sourceforge.io/documentation.html)，该文档涵盖符号计算、数值分析与公式推导功能，是研究与学习的重要参考文献。

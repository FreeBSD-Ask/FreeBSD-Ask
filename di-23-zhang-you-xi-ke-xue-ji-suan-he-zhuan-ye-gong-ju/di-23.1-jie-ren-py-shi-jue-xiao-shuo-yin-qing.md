...
本小节介绍如何将 Ren'Py 界面设置为中文。具体操作步骤可参见以下截图，包括选择语言选项并应用更改。
...
本节以《心跳文学部！》为例，其他游戏也可采用相同操作方式。选择附带 Linux 版本的游戏进行解压，即同时包含 Windows 和 Linux 版本的游戏文件。

...
经过测试，[Minecraft 官方服务器端](https://www.minecraft.net/en-us/download/server)可以直接在 FreeBSD 15.0 上运行，只需安装 OpenJDK 即可。官方服务器程序为纯 Java 程序，因此可直接在 FreeBSD 上运行。Ports 版本则提供了 FreeBSD 特定的集成配置，包括服务管理脚本和默认配置文件。

...
- Oracle. Oracle VM VirtualBox Extension Pack[EB/OL]. [2026-04-17]. <https://docs.oracle.com/en/virtualization/virtualbox/7.0/user/Introduction.html>. docs.oracle.com. 扩展包提供 USB 2.0/3.0、磁盘镜像加密、VRDP 等功能。

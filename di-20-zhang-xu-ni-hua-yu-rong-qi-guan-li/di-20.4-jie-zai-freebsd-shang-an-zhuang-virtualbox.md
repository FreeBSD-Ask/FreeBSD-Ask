...
自 4.0 起，VirtualBox 只有开源版本 Open Source Edition（OSE），剩余的组件以闭源扩展包（VirtualBox Extension Pack）的形式单独提供，**尚不支持** FreeBSD：该扩展包提供 USB 2.0/3.0 支持、磁盘镜像加密、VRDP 远程桌面协议等附加功能。

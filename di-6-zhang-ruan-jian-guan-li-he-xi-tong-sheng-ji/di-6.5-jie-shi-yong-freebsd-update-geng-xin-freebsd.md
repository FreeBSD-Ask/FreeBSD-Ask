...
> **警告**
>
> freebsd-update 支持 amd64、arm64（aarch64）和 i386 架构的 RELEASE、ALPHA、BETA、RC 版本。**CURRENT、STABLE 和 PRERELEASE 分支不提供二进制更新**，若使用 freebsd-update 将直接报错退出。上述分支必须通过源码编译方式或者 pkgbase 更新。

...
加载所需内核模块后，将 USB 数据线连接到 FreeBSD 系统与移动设备之间，随后在移动设备上开启 USB 网络共享功能。具体开启方式因设备品牌和系统版本而异，通常可在移动设备的“设置”、“网络”或“个人热点”菜单中找到相关选项。需注意，某些设备可能需要先启用 USB 调试（对于 Android 设备）或信任此计算机（对于 iOS 设备）才能正常工作。

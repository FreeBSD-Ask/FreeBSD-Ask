...
浏览器是日常使用最为频繁的软件之一。本节将介绍如何在 FreeBSD 上安装和配置常用的浏览器，包括火狐浏览器（Firefox）和 Chromium 等。
...
- 首先，`Chromium` 并非 `Google Chrome`，前者是 The Chromium Project 在 [BSD 3-Clause “New” or “Revised” License](https://github.com/chromium/chromium/blob/main/LICENSE) [备份](https://web.archive.org/web/20260118163224/https://github.com/chromium/chromium/blob/main/LICENSE) 下发布的开源与自由软件，后者是 Google LLC 的专有软件。

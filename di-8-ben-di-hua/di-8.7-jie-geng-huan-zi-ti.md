...
- [vidcontrol font and color via /etc/rc.conf problem](https://forums.freebsd.org/threads/vidcontrol-font-and-color-via-etc-rc-conf-problem.81696/) 。该讨论帖探讨了控制台字体与颜色配置的相关问题。

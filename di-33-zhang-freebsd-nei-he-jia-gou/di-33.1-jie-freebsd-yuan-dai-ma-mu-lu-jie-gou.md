...
├── ufs/                         # UFS 文件系统
├── vm/                          # 虚拟存储器系统
├── x86/                         # x86 架构相关代码（i386 与 amd64 共享）
├── xdr/                         # 外部数据表示 (XDR) 相关
└── xen/                         # 开放源代码虚拟机监视器
```

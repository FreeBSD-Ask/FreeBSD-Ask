...
VirtualBox 在 FreeBSD 上有多个版本可供选择。6.1 版本（legacy）和 7.0 版本已停止上游支持，7.1 和 7.2 版本为当前维护版本。各版本均提供了 X11 的 `-nox11` 变体（例如 `emulators/virtualbox-ose-nox11-71`），适用于无图形界面的服务器环境，仅可通过命令行工具 `VBoxManage` 操作。

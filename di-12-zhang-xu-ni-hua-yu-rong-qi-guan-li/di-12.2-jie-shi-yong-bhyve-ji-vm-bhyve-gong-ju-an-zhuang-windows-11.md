...
```sh
# vm install winguest /home/ykla/en-us_windows_11_iot_enterprise_ltsc_2024_x64_dvd_f6b14814.iso # 替换成实际的路径
Starting winguest
...
2. 修改虚拟机配置文件中的网络设备类型（从 e1000 改为 virtio-net），在 Windows 虚拟机中安装对应驱动，验证网络功能是否正常，并将步骤记录到本文。

...
> **注意**
>
> pkg 仅管理第三方软件包，不承担升级系统或获取安全更新的功能。这是由于 FreeBSD 项目将内核与用户空间作为整体统一维护，而非如 Linux 那般由 Linus Torvalds 负责内核维护、各发行版负责 GNU 工具链维护（此类组件设计为独立软件包，故可通过包管理器完成系统更新与升级）。
>
...
> **警告**
>
> 本节仅针对 Linux 兼容层缺少 `.so` 文件的问题。如果在 FreeBSD 上遇到了此类问题，应首先更新系统，然后再更新软件源和软件。

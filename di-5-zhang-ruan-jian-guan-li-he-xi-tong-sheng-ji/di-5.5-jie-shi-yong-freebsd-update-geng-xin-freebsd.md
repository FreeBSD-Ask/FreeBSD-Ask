...
FreeBSD 提供了实用工具 `freebsd-update`，用于安装系统更新，包括升级到新的大版本。`freebsd-update` 最早在 FreeBSD 6.2-RELEASE 中纳入基本系统，用于安全更新和勘误补丁；在 FreeBSD 6.3-RELEASE 中引入了 upgrade 命令，至 7.0-RELEASE 时正式成为官方支持的升级途径。

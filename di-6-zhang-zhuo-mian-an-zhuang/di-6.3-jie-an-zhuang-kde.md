...
- [Missing power buttons when logged in from SDDM](https://forums.freebsd.org/threads/missing-power-buttons-when-logged-in-from-sddm.88231/) 。FreeBSD 官方论坛讨论，解决 SDDM 登录后电源按钮缺失的技术问题。

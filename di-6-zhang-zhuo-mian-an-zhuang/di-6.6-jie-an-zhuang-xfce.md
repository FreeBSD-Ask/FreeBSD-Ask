...
- [Zsh - Arch Linux 中文维基](https://wiki.archlinuxcn.org/wiki/Zsh) [备份](https://web.archive.org/web/20260122092937/https://wiki.archlinuxcn.org/wiki/Zsh)。Arch Linux 中文维基提供的 Zsh 配置详细教程，本文 Zsh 配置源自此。

...
- [X11vnc](https://wiki.archlinux.org/title/X11vnc) 。Arch Linux 官方维基提供的 X11vnc 配置与使用详细指南。
...
- [Xfce4 is not displayed correctly when I connect vncviewer (in Linux) to tightvnc-server (on FreeBSD)](https://forums.freebsd.org/threads/xfce4-is-not-displayed-correctly-when-i-connect-vncviewer-in-linux-to-tightvnc-server-on-freebsd.85709/) 。FreeBSD 官方论坛讨论，解决 VNC 远程连接中 Xfce4 显示异常的技术问题。
...
- [FreeRDP User Manual](https://github.com/awakecoding/FreeRDP-Manuals/blob/master/User/FreeRDP-User-Manual.markdown) 。GitHub 提供的 FreeRDP 用户手册，包含完整命令说明与实用示例。
...
- [使用 RDP 连接到 Azure VM 时排查身份验证错误](https://learn.microsoft.com/zh-cn/troubleshoot/azure/virtual-machines/windows/cannot-connect-rdp-azure-vm) 。Microsoft 官方文档提供的 RDP 网络级身份验证（NLA）配置方法与故障排除指南。
...
- [远程控制软件 RustDesk 自建服务器全平台部署及使用教程](https://www.cnblogs.com/safe-rabbit/p/18020812) 。博客园提供的 RustDesk 自建中继服务器全平台部署与使用详细教程。

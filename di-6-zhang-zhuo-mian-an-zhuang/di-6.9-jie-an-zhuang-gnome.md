...
- [恢复 GNOME 顶栏的托盘图标](https://linuxstory.org/restore-tray-icon-for-gnome-top-bar/) [备份](https://web.archive.org/web/20260121071945/https://linuxstory.org/restore-tray-icon-for-gnome-top-bar/)。提供恢复 GNOME 顶栏托盘图标显示的详细步骤与扩展安装指南。

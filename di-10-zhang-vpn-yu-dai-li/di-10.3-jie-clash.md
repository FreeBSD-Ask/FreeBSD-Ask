...
已向 Ports 维护者发出请求合并（[Bug 291295 - net/mihomo: Add rc.conf and some Post-installation](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=291295) [备份](https://web.archive.org/web/20260115020637/https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=291295)），但目前尚未收到回应。在官方集成完成前，可使用下文提供的自定义 RC 脚本实现服务化管理。
...
[wenyinos/clash-for-freebsd](https://github.com/wenyinos/clash-for-freebsd) [备份](https://web.archive.org/web/20260115134506/https://github.com/wenyinos/clash-for-freebsd)

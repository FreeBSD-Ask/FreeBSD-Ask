...
WildFly（原 JBoss Application Server）是由 Red Hat 公司开发的开源 Java EE（Java Platform, Enterprise Edition）应用服务器，为企业级 Java 应用提供运行时环境与服务。
...
4. 对 WildFly 进行安全加固，使之适用于生产环境。总结并提交 PR 至本文。

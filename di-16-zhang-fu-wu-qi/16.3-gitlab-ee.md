...
GitLab 需要使用 PostgreSQL 数据库。当前 GitLab 支持的 PostgreSQL 版本为 16 及更高版本。
...
>**警告**
>
>此部分内容仅供个人学习参考，不得用于商业用途。本书不承担相关责任。请支持正版：[购买许可证](https://about.gitlab.com/pricing/) [备份](https://web.archive.org/web/20260115140653/https://about.gitlab.com/pricing/)。
...
[GitLab EE 16 安装破解教程](https://blog.mengguyi.com/articles/GitLab-Install.html) [备份](https://web.archive.org/web/20260115043343/https://blog.mengguyi.com/articles/GitLab-Install#%E7%BC%96%E8%AF%91-gitaly)
...
- [CI/CD 笔记 .Gitlab 系列：2024 更新后 - 设置 GitLab 导入源](https://bbs.huaweicloud.com/blogs/423539) [备份](https://web.archive.org/web/20260122075941/https://bbs.huaweicloud.com/blogs/423539)
...
- [CentOS 7 上 GitLab 的安装、备份、迁移及恢复](https://www.ifeegoo.com/the-installation-backup-migration-restore-of-gitlab-on-centos-7.html)，该文档提供了 GitLab 常见问题排查与数据管理的实用指南。

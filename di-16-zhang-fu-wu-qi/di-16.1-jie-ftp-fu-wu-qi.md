...
在 FreeBSD 系统中搭建 FTP 服务器，能够实现局域网或互联网环境下的文件快速传输与共享。
...
- RFC 2640[EB/OL]. [2026-03-26]. <https://www.rfc-editor.org/rfc/rfc2640>（Internationalization of the File Transfer Protocol，FTP 协议的国际化）的支持，该 RFC 定义了 FTP 的国际化框架。

...
INSERT INTO `users` VALUES ('demo', 'demo&2022*', 2002, 2000, '/home/ftpusers', 500, 30, 80, 80, '*', NULL, NULL, 1, 1);
```
...
```sh
# pure-pw useradd ftpuser2 -u 2001 -g 2001 -d /home/ftpusers2/
Password:
Enter it again:
# pure-pw mkdb
# pure-pw list
ftpuser             /home/ftpusers/./
```

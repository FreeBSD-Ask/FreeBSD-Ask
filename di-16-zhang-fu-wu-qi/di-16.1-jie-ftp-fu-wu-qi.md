...
本章介绍了三种常用的 FTP 服务器软件：

| 软件 | 特点 | 适用场景和人群 |
| ---- | ---- | -------------- |
| Pure-FTPd | ISC 许可证授权、安全优先、支持多种操作系统、FTP 协议规范实现较为完整 | 为 ISP 和托管服务提供高度灵活性，适用于新手 |
...
使用安全套接字层/传输层安全（SSL/TLS）加密的 FTP 为 FTPS（FTP over SSL, 继任者是 FTP over TLS）。

构建在 SSH 之上的 FTP 协议版本称为安全文件传输协议（Secure File Transfer Protocol, SFTP）。
...
- osc_e0e3b1a8. Linux 环境下 FTP 权限设置详解与操作步骤全攻略[EB/OL]. [2026-03-25]. <https://my.oschina.net/emacs_8748786/blog/17171107>.

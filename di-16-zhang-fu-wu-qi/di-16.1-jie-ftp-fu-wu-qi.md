...
FTP（File Transfer Protocol，文件传输协议）是 TCP/IP 协议栈中最早的应用层协议之一。
...
本节以 MySQL 8.x 为例。有关 MySQL 的安装和基本配置，请参见其他章节。请自行安装配置 MySQL 8.x。
...
- RFC 2640[EB/OL]. [2026-03-26]. <https://www.rfc-editor.org/rfc/rfc2640>. 该 RFC 定义了 FTP 协议的国际化框架（Internationalization of the File Transfer Protocol）。

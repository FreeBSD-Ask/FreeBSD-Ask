...
```
# mkdir /home/pureftp/www
# chown -R ftpuser /home/pureftp/www
# chgrp -R ftpgroup /home/pureftp/www
```

- 添加虚拟用户 ftpuser

```sh
# pure-pw useradd ftpuser -u 2001 -g 2000 -d /home/pureftp/www -m
Password:
Enter it again:
```
...
```sh
# pure-pw list
ftpuser             /home/ftpusers/www./
```

```sh
root@ykla:/ # pure-pw show ftpuser

Login              : ftpuser
Password           : $argon2id$v=19$m=8192,t=255,p=1$NBGoWqBK4vFiR/q23yXCKw$za3YI29bek9plHT2HqVjWHWRUUQSg4KKKKLcYrDnQ+0
UID                : 2000 (-)
GID                : 2000 (ftpgroup)
Directory          : /home/ftpusers/www./
Full name          :
...
root@localhost [(none)]> use pureftpd;
Database changed
root@localhost [pureftpd]> select * from users;
Empty set (0.00 sec)

root@localhost [pureftpd]>
```
### 服务操作

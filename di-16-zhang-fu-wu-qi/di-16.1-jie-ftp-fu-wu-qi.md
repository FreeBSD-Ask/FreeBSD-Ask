...
Pure-FTPD 已移除对 RFC 2640 的支持，因此在 Windows 系统下使用 ftp 命令行访问包含非英文字符的文件可能出现乱码，且无法修改编码。参见 [Version 1.0.48 released](https://www.pureftpd.org/project/pure-ftpd/news)。

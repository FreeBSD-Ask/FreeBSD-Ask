...
>**技巧**
>
>可以通过 Ports 获取 WildFly 历史版本，但存在 Bug [java/wildfly: service start fail, illegal group name](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=285956) [备份](https://web.archive.org/web/20260115020631/https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=285956)，历史版本需要自行应用补丁。

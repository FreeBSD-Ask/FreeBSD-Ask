...
GitLab 需要使用 PostgreSQL 数据库。当前 GitLab 要求 PostgreSQL 版本为 16 及以上。
...
……此处省略。该步骤大概需要几十分钟；若提示内存溢出，请增加 swap。一般来说需要执行两次，若内存溢出则需要再重复执行一次……
...
>**警告**
>
>此部分内容仅供个人学习参考，不得用于商业用途。本书作者及出版方不承担相关责任。请支持正版：[购买许可证](https://about.gitlab.com/pricing/)。

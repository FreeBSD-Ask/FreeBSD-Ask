...
- [mount_nfs -- mount NFS file systems](https://www.freebsd.org/cgi/man.cgi?mount_nfs(8)) )，该手册页提供了 mount_nfs 命令的完整参数说明。
- [李守中](https://note.lishouzhong.com/article/translation/sitemap-index.html) ，该站点包含大量 Unix/Linux 技术文档的中文翻译。
- [freebsd nfs 挂载遇到的问题](https://blog.51cto.com/chhquan/1708250) ，该文章分析了 FreeBSD NFS 挂载常见问题及解决方案。

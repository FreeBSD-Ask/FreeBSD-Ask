...
本小节介绍如何在 FreeBSD 系统上安装和运行 Minecraft 客户端。
...
Prism Launcher 默认 **禁止离线登录**，并且还会主动封禁[任何绕过方法](https://github.com/antunnitraj/Prism-Launcher-PolyMC-Offline-Bypass)。
...
本小节介绍如何在 FreeBSD 系统上搭建 Minecraft 服务器。

...
过旧的 JDK 版本不受支持，本文测试使用 JDK 23 可正常运行。
...
经过测试 [Minecraft 官方服务器端](https://www.minecraft.net/en-us/download/server) [备份](https://web.archive.org/web/20260119034814/https://www.minecraft.net/en-us/download/server) 可以直接在 FreeBSD 14.2 上运行。只需安装 OpenJDK 即可运行。

...
上一节我们使用 GLPK 求解线性规划问题，本节我们使用性能更加强大的 wxMaxima 来解决问题，该系统不仅可以进行数值计算，还支持符号运算与公式推导。以下代码仅供参考，如果想深入了解，可查看 [官方文档](https://maxima.sourceforge.io/documentation.html) [备份](https://web.archive.org/web/20260116224714/https://maxima.sourceforge.io/documentation.html)。

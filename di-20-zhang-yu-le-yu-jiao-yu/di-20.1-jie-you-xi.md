...
从 [releases](https://github.com/HMCL-dev/HMCL/releases) 下载最新的发行版本（写作本文时为 `HMCL-3.6.11.265.jar`）。

打开终端执行

```sh
$ java -jar HMCL-3.6.11.265.jar
```
...
失败。参见 [[Bug] FreeBSD 下运行报错 Could not initialize class com.mojang.blaze3d.systems.RenderSystem](https://github.com/HMCL-dev/HMCL/issues/3529)。

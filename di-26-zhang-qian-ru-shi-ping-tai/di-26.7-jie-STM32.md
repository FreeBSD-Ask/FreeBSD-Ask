...
set(ASM_SOURCES "startup_stm32f103xb.s")  # 占位符——启动文件，须改为实际型号对应的启动文件
...
target_link_options(${PROJECT_NAME} PRIVATE
    ${MCU_FLAGS}
    -Wl,--gc-sections
    -T${CMAKE_CURRENT_SOURCE_DIR}/STM32F103XX_FLASH.ld  # 占位符——链接脚本，须改为实际型号对应的 .ld 文件
    -specs=nosys.specs
...
> **技巧**
>
> 更换 STM32 型号时，CMakeLists.txt 中有多处与具体 MCU 型号绑定的占位符，须逐一调整。最简便的做法是：在 STM32CubeMX 中切换目标芯片后重新生成项目，再对照修改 CMakeLists.txt 中对应位置。
>

...
本节介绍如何在 FreeBSD 上配置 Rust（通过 rustup 或 pkg）开发环境，包括工具链安装与版本设置。
...
> **注意**
>
> 本节中 Rust 版本号 `1.95.0` 为撰写时的 Ports 版本。请根据当前 FreeBSD Ports 中可用的最新 Rust 版本调整，可通过 `pkg search rust` 查询可用版本。

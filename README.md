...
- 微信群：受微信平台功能限制，需先加入 QQ 群，联系群主获取入群二维码。
- Discord：<https://discord.gg/j7VhWrhp3e>
...
自 2022 年 6 月 1 日起，本书访问情况如下（数据由 [Google Analytics](https://analytics.google.com/) 收集，用户总数指独立访问者数量，会话数指用户访问序列数量，浏览次数指页面加载次数，平均会话时长指用户每次访问的平均停留时间：
...
![总用户数](https://img.shields.io/badge/总用户数-44,284-green)
![会话数](https://img.shields.io/badge/会话数-92,488-orange)
![浏览次数](https://img.shields.io/badge/浏览次数-633,550-blue)
![平均会话时长](https://img.shields.io/badge/平均会话时长-8min51s-purple)
...
文档总字数：105.24 万字（统计范围：本书所有 Markdown 文档正文内容）；

统计时间：2026-03-22 13:41:09（北京时间）

与上周相比：+12.03 万字（+12.91%）

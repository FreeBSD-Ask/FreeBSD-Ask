...
|3303672033|开源邪教，半瓶水晃荡，认为`LaTeX`在写小说方面优于`Word`，认为`libreoffice`不应该兼容`Word`，应该反过来由`Word`去兼容他,经典语录"你凭什么说 Libreoffice 兼容性不好?"，“你为什么不用 GIMP？为什么用 PS”，“你为什么用 Windows 10”。侮辱挑衅管理员|

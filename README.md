...
我们认为“入门”是一种快乐，“跑路”亦是一种豁达。“本乘兴而行，兴尽而反，何必 FreeBSD 邪！”[^注 1]

## 📄 内容提要

这是一本开源的 FreeBSD 操作系统研究书籍，还包含一些 OpenBSD、NetBSD 等 Berkeley Unix 家族的导论章节。

[~~FreeBSD 项目即将归档（Archived）~~，为了保护我们心爱的操作系统……我们能做的事情就是，写一本书！](https://www.bilibili.com/bangumi/media/md3068)[^注 2]
...
![总用户数](https://img.shields.io/badge/总用户数-41,627-green)
![会话数](https://img.shields.io/badge/会话数-86,484-orange)
![浏览次数](https://img.shields.io/badge/浏览次数-605,824-blue)
...
[^注 1]: 转写自房玄龄.晋书·王羲之传附王徽之传 [M].中华书局，1974
[^注 2]: 转写自《Love Live! School Idol Project》口号

...
- 如果你熟悉 GitHub，可以用点击电脑端右侧的“编辑此页”，进入项目进行操作。整个项目使用 Markdown 语法 +  Gitbook，简单易上手（具体详见项目 WiKi）；
- 如果以上有困难，你还可以发 PDF、Word 或者 TXT 给我。请将文件发送至 `yklaxds@gmail.com`；如果有视频教程，可发各大云盘链接为宜。

本项目欢迎一切与 BSD 相关（包括不限于 FreeBSD，OpenBSD，NetBSD）以及各种体系结构的教程。你既可以扩充当前教程，也可以新建一节。

将你的教程合并到本书的一个最大优点就是随处可见，不用再到处乱找了，亦可轻松复现成果。

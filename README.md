...
电子书的生成由 [safreya](https://github.com/safreya) [备份](https://web.archive.org/web/20260120013715/https://github.com/safreya) 开发的 [GitBook PDF/EPUB 导出工具](https://github.com/FreeBSD-Ask/gitbook-pdf-export) [备份](https://web.archive.org/web/20260119111555/https://github.com/FreeBSD-Ask/gitbook-pdf-export) 提供支持。
...
由于架构设计原因，您必须使用 GitHub 账户登录方可留言，并且您在 docs 上的评论将会公开到 GitHub 存储库 [Handbook-giscus-discussions](https://github.com/FreeBSD-Ask/Handbook-giscus-discussions) [备份](https://web.archive.org/web/20260119111623/https://github.com/FreeBSD-Ask/Handbook-giscus-discussions) 的 Discussions 中，您可自行前往上述位置管理您的历史留言。

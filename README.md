...
由于架构设计问题，您必须使用 GitHub 账户进行登录才能留言，并且您在 docs 上的评论将会公开到 GitHub 存储库 [/Handbook-giscus-discussions](https://github.com/FreeBSD-Ask/Handbook-giscus-discussions) 的 Discussions 中，您可以前往上述位置管理您的历史留言。
...
![总用户数](https://img.shields.io/badge/总用户数-41,117-green)
![会话数](https://img.shields.io/badge/会话数-85,187-orange)
![浏览次数](https://img.shields.io/badge/浏览次数-597,758-blue)

...
[~~FreeBSD 项目归档（Archived）~~，为了保护我们心爱的操作系统……我们能做的事情就是，写一本书！](https://www.bilibili.com/bangumi/play/ep79879)
...
![总用户数](https://img.shields.io/badge/总用户数-41,346-green)
![会话数](https://img.shields.io/badge/会话数-85,721-orange)
![浏览次数](https://img.shields.io/badge/浏览次数-600,935-blue)

...
与绝大多数操作系统不同，BSD 既提供了二进制包供用户快速安装，亦提供了源代码的方式来供用户自定义配置。古今两种思潮汇聚于此。如果有人既悬置道，也悬置术——正如此篇文章一样。很难想象他该有多么快乐呐！在现在的时代里，快乐是极难获得的。睁眼看看这个世界，有哪一点是能够让人满足的？郭德纲都说这年头花钱能买个高兴已经是不易了。

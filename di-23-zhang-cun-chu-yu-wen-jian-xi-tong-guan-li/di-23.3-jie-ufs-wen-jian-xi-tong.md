...
- CHOI Jaeyoon. Universal Flash Storage on FreeBSD[EB/OL]. [2026-04-16]. <https://freebsdfoundation.org/our-work/journal/browser-based-edition/freebsd-15-0/universal-flash-storage-on-freebsd/>. 该文介绍了 FreeBSD UFS 驱动的开发过程及当前状态。

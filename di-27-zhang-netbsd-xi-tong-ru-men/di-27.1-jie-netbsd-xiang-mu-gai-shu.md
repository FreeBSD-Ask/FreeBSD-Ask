...
- The NetBSD Foundation. Platforms Supported by NetBSD[EB/OL]. [2026-04-18]. <https://wiki.netbsd.org/ports/>. NetBSD 官方架构支持页面，明确记载当前有 9 个一级架构（Tier I）和 49 个二级架构（Tier II）。
...
- Nouveau Project. CodeNames[EB/OL]. freedesktop.org, [2025-04-17]. <https://nouveau.freedesktop.org/CodeNames.html>. nouveau GPU 架构与代号映射表。

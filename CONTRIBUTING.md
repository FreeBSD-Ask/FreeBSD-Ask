...
- [ ] 第 24 章 虚拟化（Xen 真难用，而且删除了 PV 支持，似乎无意义）
  - [ ] 24.8.基于 FreeBSD 的 Xen™ 虚拟机（真的支持 Windows 11 吗？10 也行）
  - [ ] 24.6.使用 FreeBSD 上的 QEMU 虚拟化
- [ ] 第 26 章 FreeBSD 更新与升级
  - [ ] 26.7.多台机器的追踪
  - [ ] 26.8.在非 FreeBSD 主机上进行构建（和前面的交叉编译重复了，可合并）

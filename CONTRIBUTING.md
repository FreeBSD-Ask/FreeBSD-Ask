...
* signingkey; 指设置带签名提交时默认使用的签名密钥 注：signingkey 可指 GPG Keys 亦可指 SSH Keys ，因为自 Git 2.34 起，Git支持了SSH签名验证功能。参见: [关于提交签名验证 - Github Docs](https://docs.github.com/zh/authentication/managing-commit-signature-verification/about-commit-signature-verification)
## 开放任务

...
远程桌面访问技术能让用户通过网络从一台设备远程控制另一台设备的桌面环境。本节将系统阐述在 FreeBSD 操作系统中配置和使用多种远程桌面协议的具体方法，包括 VNC、RDP 等主流协议。
...
请注意，须将左上 🖱️ 改为 👆。默认的鼠标操作很不方便：或者也可以选择手机通过 OTG 鼠标和键盘来操控。
...
根据 rdesktop team. CredSSP does not work[EB/OL]. [2026-04-04]. <https://github.com/rdesktop/rdesktop/issues/71>. 是个老问题了。

...
图 6.9-1 展示了 FreeBSD 上的 GNOME 登录界面（默认情况下禁止 root 登录）。

![FreeBSD Gnome](../.gitbook/assets/gnome2.png)

图 6.9-2 展示了 GNOME 桌面环境的默认界面（默认壁纸即为所示）。

![FreeBSD Gnome](../.gitbook/assets/gnome3-1.png)

图 6.9-3 展示了 GNOME 桌面环境的应用菜单。
...
图 6.9-5 展示了 GNOME 扩展管理界面。

![Gnome 恢复 GNOME 顶栏的托盘图标](../.gitbook/assets/gnome4.png)

图 6.9-6 展示了 AppIndicator 扩展安装界面。
...
图 6.9-11 展示了使用 Desktop Icons NG 扩展在 GNOME 桌面上放置图标的效果（壁纸是自定义的，其他均为默认设置）。

...
CDE 是通用桌面环境（Common Desktop Environment，CDE）的缩写，是一款具有悠久历史的桌面环境，曾广泛应用于 UNIX 商业发行版。
...
- FreeBSD Project. Setting up Common Desktop Environment for modern use[EB/OL]. [2026-03-25]. <https://forums.freebsd.org/threads/setting-up-common-desktop-environment-for-modern-use.69475/>. 详细配置可参考此处。

...
| `lightdm-gtk-greeter` | LightDM 的 GTK+ 登录界面插件（LightDM GTK+ Greeter），LightDM 需要至少一个 greeter 才能正常工作 |
...
- 列奥那多是勇者. 从零开始的 Bspwm 安装与配置教程[EB/OL]. 知乎专栏, [2026-03-25]. <https://zhuanlan.zhihu.com/p/568211941>. 知乎专栏提供的 Bspwm 窗口管理器详细安装与配置中文教程。

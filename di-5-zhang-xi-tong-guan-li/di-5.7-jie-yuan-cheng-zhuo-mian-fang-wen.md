...
本节阐述在 FreeBSD 操作系统中配置和使用多种远程桌面协议的方法，包括 VNC、RDP 等主流协议。
...
x11vnc 提供屏幕镜像功能，用户的操作会同步显示在物理显示器上，显示器上的操作在 VNC 上也可以看到。建议配合 SSH 隧道或 SSL 加密使用，避免 VNC 流量被嗅探。
...
![SDDM X11VNC](../.gitbook/assets/sddm-x11vnc.png)
...
![SDDM VNC](../.gitbook/assets/sddm-vnc-1.png)
...
![SDDM VNC](../.gitbook/assets/sddm-vnc-2.png)
...
![xrdp FreeBSD](../.gitbook/assets/xrdp-1.png)

首次登录设备会有安全提示，输入 `yes`，回车后弹出远程桌面窗口。

![xrdp FreeBSD](../.gitbook/assets/xrdp-2.png)

![xrdp FreeBSD](../.gitbook/assets/xrdp-3.png)

![xrdp FreeBSD](../.gitbook/assets/xrdp-4.png)

![xrdp FreeBSD](../.gitbook/assets/xrdp-5.png)
...
![智能调整大小](../.gitbook/assets/xrdp-smart-resize.png)
...
![Remote Desktop FreeBSD](../.gitbook/assets/remote-desktop-bsd-1.png)

连接示意图（后台正在编译 Chromium，故占用会很高）：

![Remote Desktop FreeBSD](../.gitbook/assets/remote-desktop-bsd-2.png)
...
![freerdp](../.gitbook/assets/freerdp-2.png)
...
![freerdp](../.gitbook/assets/freerdp-1.png)
...
![rdesktop](../.gitbook/assets/rdesktop-1.png)

![rdesktop](../.gitbook/assets/rdesktop-2.png)
...
![anydesk](../.gitbook/assets/anydesk-1.png)
...
![AnyDesk 主界面](../.gitbook/assets/anydesk-main.png)

被连接方必须“接受”（Accept）才能继续连接。

### Windows 通过 AnyDesk 远程访问 FreeBSD

![Windows 通过 AnyDesk 远程 FreeBSD](../.gitbook/assets/anydesk-win-to-bsd.png)

### FreeBSD 通过 AnyDesk 远程访问 Windows

![FreeBSD 通过 AnyDesk 远程 Windows](../.gitbook/assets/anydesk-bsd-to-win.png)

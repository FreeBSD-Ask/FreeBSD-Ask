...
大多数界面都有 **Help** 按钮，建议充分利用该功能，其通常提供有用的上下文相关提示；如果在某个配置菜单中不确定操作方式，请选择 **Help**。
...
3. bsdconfig 是一个全功能配置工具，但其设计意图在“向导式配置”与“脚本化配置”之间摇摆。分析这种双重定位对工具的维护成本和代码质量的负面影响，讨论配置工具是否应明确选择其中一种设计定位。

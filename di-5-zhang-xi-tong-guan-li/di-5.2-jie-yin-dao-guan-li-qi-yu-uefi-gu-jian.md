...
![loader 更新提示界面](../.gitbook/assets/loader-update-prompt.png)
...
![复制 rEFInd 到 EFI 分区](../.gitbook/assets/refind-copy-efi.png)

### 添加启动项

使用 [DiskGenius](https://www.diskgenius.com/) 添加 UEFI 引导项。

![添加 UEFI 引导项](../.gitbook/assets/refind-add-uefi-entry.png)

点击菜单栏的“工具”，选择“设置 UEFI BIOS 启动项”。

![设置 UEFI BIOS 启动项](../.gitbook/assets/refind-set-bios-boot.png)
...
![移动启动项至顶部](../.gitbook/assets/refind-move-entry-top.png)

![rEFInd 启动界面](../.gitbook/assets/refind-boot-screen.png)

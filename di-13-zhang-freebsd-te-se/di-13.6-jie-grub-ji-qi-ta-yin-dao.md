...
- [efibootmgr 无法添加 UEFI 启动项](https://bbs.archlinuxcn.org/viewtopic.php?id=12914) [备份](https://web.archive.org/web/20260115041824/https://forum.archlinuxcn.org/t/topic/12295?redirected_from=https://bbs.archlinuxcn.org/viewtopic.php?id%3D12914)，提供了简洁明了的 efibootmgr 操作指南
- [efibootmgr(8)](https://man.freebsd.org/cgi/man.cgi?efibootmgr(8))，FreeBSD 官方手册页，提供了 efibootmgr 命令的完整英文技术文档
- [深入掌握 efibootmgr 操作要领安全删除启动项方法解析](https://my.oschina.net/emacs_8861834/blog/17450288)，提供了 efibootmgr 操作的详细说明，部分内容适用于 BSD 系统
...
此示例删除 nda0 上由 FreeBSD 安装生成的 EFI 分区，将 FreeBSD 的引导文件迁移到 `ada0` 硬盘的 EFI 分区中。
...
若再次启动 FreeBSD 没有问题，方可使用 [DiskGenius](https://www.diskgenius.cn/) [备份](https://web.archive.org/web/20260119050957/https://www.diskgenius.cn/) 或其他分区工具删除 nda0 磁盘的 EFI 分区及文件。


## Grub

本小节将介绍 Grub 引导管理器的使用。
...
- [Working GRUB configuration for UEFI booting FreeBSD](https://unix.stackexchange.com/questions/354260/working-grub-configuration-for-uefi-booting-freebsd) [备份](https://web.archive.org/web/20260115135729/https://unix.stackexchange.com/questions/354260/working-grub-configuration-for-uefi-booting-freebsd)，提供了 UEFI 模式下通过 GRUB 引导 FreeBSD 的完整工作配置
- [Trying to boot FBSD13 via grub2](https://www.reddit.com/r/freebsd/comments/q4qgq9/trying_to_boot_fbsd13_via_grub2/) [备份](https://web.archive.org/web/20260121055324/https://www.reddit.com/r/freebsd/comments/q4qgq9/trying_to_boot_fbsd13_via_grub2/)，分享了通过 GRUB2 引导 FreeBSD 13 的尝试及相关经验

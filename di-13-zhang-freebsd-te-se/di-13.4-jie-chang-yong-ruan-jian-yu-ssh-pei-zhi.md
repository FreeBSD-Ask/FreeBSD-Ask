...
OpenSSH 是 FreeBSD 基本系统内置的 SSH 实现。OpenSSH 位于 [/crypto/openssh](https://github.com/freebsd/freebsd-src/tree/main/crypto/openssh)，通过 `ChangeLog` 可以简单地获取当前内置的版本号。
...
- [mosh FAQ](https://mosh.org/#faq) [备份](https://web.archive.org/web/20260115041453/https://mosh.org/#faq)，提供了 Mosh 移动 Shell 的常见问题解答及技术细节
- [ssh && mosh](https://silbertmonaphia.github.io/ssh%E7%99%BB%E5%BD%95%E3%81%AE%E5%91%A8%E8%BE%BA-&&-Mosh.html) [备份](https://web.archive.org/web/20260119174850/https://silbertmonaphia.github.io/ssh%E7%99%BB%E5%BD%95%E3%81%AE%E5%91%A8%E8%BE%BA-&&-Mosh.html)，详细介绍了 SSH 与 Mosh 结合使用的实践指南
- [scp — OpenSSH secure file copy](https://man.openbsd.org/scp.1) [备份](https://web.archive.org/web/20251218013632/https://man.openbsd.org/scp.1)，OpenBSD 官方 scp 命令手册页，提供了安全文件复制的技术规范

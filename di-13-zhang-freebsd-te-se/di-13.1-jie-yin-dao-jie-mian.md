...
- [FreeBSD Desktop – Part 1 – Simplified Boot](https://vermaden.wordpress.com/2018/03/29/freebsd-desktop-part-1-simplified-boot/) ，提供了 FreeBSD 启动过程简化配置的完整指南
...
- [How to find the valid values of efi_max_resolution](https://forums.freebsd.org/threads/how-to-find-the-valid-values-of-efi_max_resolution.84840/)  ，提供了 gop 方法参考及实用动图演示
...
- [customize boot loader logo](https://forums.freebsd.org/threads/customize-boot-loader-logo.72903/) ，提供了自定义引导加载程序 Logo 的详细方法
- [How to change the FreeBSD logo which appears as soon it boots with that of the little devil.](https://forums.freebsd.org/threads/how-to-change-the-freebsd-logo-which-appears-as-soon-it-boots-with-that-of-the-little-devil.85934/) ，介绍了修改 FreeBSD 启动 Logo 的尝试及问题说明
- [loader: Load a splash screen if "splash" variable is defined](https://reviews.freebsd.org/D45932)  ，提出了引导程序启动画面加载功能的技术实现方案

...
- Espressif Systems. ESP-IDF 编程指南：分区表[EB/OL]. (2025-?) [2026-04-19]. <https://docs.espressif.com/projects/esp-idf/zh_CN/v6.0/esp32/api-guides/partition-tables.html>. 官方分区表介绍。
- Espressif Systems. Flashing Firmware — ESP32 esptool documentation [EB/OL]. (2026-04-19)[2026-04-19]. <https://docs.espressif.com/projects/esptool/en/latest/esp32/esptool/flashing-firmware.html>. 官方刷写固件的方法。

...
- [Anonymous CVS](https://www.openbsd.org/anoncvs.html)  官方 CVS 匿名访问指南，提供代码仓库获取方法。
- [FAQ - Building the System from Source](https://www.openbsd.org/faq/faq5.html)  详细说明从源码编译系统的步骤与配置。
- [release — building an OpenBSD release](https://man.openbsd.org/release)  官方手册页，介绍发布版本构建流程。

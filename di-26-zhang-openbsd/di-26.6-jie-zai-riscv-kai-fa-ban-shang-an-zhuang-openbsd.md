...
> **警告**
>
> 在阅读本文之前，请读者务必先查阅 [https://doc.rvspace.org/VisionFive2/PDF/VisionFive2\_QSG.pdf](https://doc.rvspace.org/VisionFive2/PDF/VisionFive2_QSG.pdf) [备份](https://web.archive.org/web/20251207045851/https://doc.rvspace.org/VisionFive2/PDF/VisionFive2_QSG.pdf)，否则可能无法理解本文内容。
...
成功进入 OpenSBI 后，需要配置网络并加载必要的文件来启动 OpenBSD。
...
- [Installing OpenBSD 7.4 on a MilkV Mars](https://mzh.io/installing-openbsd-7-4-on-a-milkv-mars) [备份](https://web.archive.org/web/20260124080110/https://mzh.io/p/590.html) MilkV Mars RISC-V 设备上 OpenBSD 7.4 的安装实践。

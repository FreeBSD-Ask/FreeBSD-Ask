...
在开始之前，建议读者先了解 RISC-V 开发板的基本启动流程。相关文档可参考 [https://doc.rvspace.org/VisionFive2/PDF/VisionFive2_QSG.pdf](https://doc.rvspace.org/VisionFive2/PDF/VisionFive2_QSG.pdf) 。
...
- [FreeBSD 与 RISC-V: 开源物联网生态系统的未来](https://feng.si/posts/2019/06/freebsd-and-risc-v-the-future-of-open-source-iot-ecosystem/)  探讨 RISC-V 架构在开源物联网领域的应用前景。
- [wiki/riscv](https://wiki.freebsd.org/riscv)  FreeBSD 官方 RISC-V 架构支持文档，提供技术参考。
- [Installing OpenBSD 7.3-current on a VisionFive2](https://gist.github.com/csgordon/74658096f7838382b40bd64e11f6983e)  VisionFive2 开发板上 OpenBSD 开发版的安装指南。
...
- [JH7110 - VF2](https://marc.info/?t=169039246400003&r=1&w=2)  邮件列表讨论，记录 JH7110 芯片与 VisionFive2 的技术交流。

...
OpenBSD 软件包管理策略较为严格，过时的软件包会被移除。例如，用户几乎找不到可用的图形登录管理器（gdm 除外）。

注意：OpenBSD 对 NVIDIA 显卡的支持，大致停留在 2009 年左右的 GT200 系列。参见 [nv - NVIDIA video driver](https://man.openbsd.org/nv.4) [备份](https://web.archive.org/web/20260120172207/https://man.openbsd.org/nv.4)（具体硬件支持列表）。
...
[CheriBSD 官网](https://www.cheribsd.org/) [备份](https://web.archive.org/web/20260120214157/https://cheribsd.org/)

...
据 Rust 维护者反馈（[OpenBSD support](https://github.com/rust-lang/rustup/issues/2168)），OpenBSD 的 ABI 十分不稳定，在这方面甚至接近 Linux。因此，Rust 团队无法通过 `rustup` 向 OpenBSD 用户提供预编译的 Rust 工具链。

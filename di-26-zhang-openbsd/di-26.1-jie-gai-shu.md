...
OpenBSD，也是一款类 Unix 计算机操作系统，诞生于 1995 年，由荷裔加拿大的程序员西奥·德若特（Theo de Raadt）从 NetBSD 复刻而来。

OpenBSD 声称是世界上最安全的操作系统（想起了 2014 年的德国电影 *[Who Am I – Kein System ist sicher](https://www.imdb.com/title/tt3042408/)* 即《[我是谁：没有绝对安全的系统](https://movie.douban.com/subject/25932086/)》）。OpenBSD 采用了 LLVM/Clang 项目来构建系统，默认 shell 为 ksh（Korn shell，作者 David G. Korn），吉祥物是一只名为普菲（Puffy）的河豚。

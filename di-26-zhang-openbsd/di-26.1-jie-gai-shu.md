...
一项多年前的研究表明，OpenBSD 中的代码漏洞数量逐年减少，并且已发现的漏洞通常难以被利用进行攻击。（J. Shi, Zou D, Xu S, Deng X, Jin H. Does OpenBSD and Firefox’s Security Improve With Time?[J]. IEEE Transactions on Dependable and Secure Computing, 2023, 20(4): 2781-2793. doi: 10.1109/TDSC.2022.3153325.）

...
OpenBSD 对 NVIDIA 显卡的支持，大致停留在 2009 年左右的 GT200 系列。参见 [nv - NVIDIA video driver](https://man.openbsd.org/nv.4) [备份](https://web.archive.org/web/20260120172207/https://man.openbsd.org/nv.4)（具体硬件支持列表）。

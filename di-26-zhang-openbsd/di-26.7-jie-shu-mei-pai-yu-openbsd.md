...
- [OpenBSD/arm64](https://www.openbsd.org/arm64.html)  OpenBSD arm64 平台支持说明，列出兼容硬件。
- [OpenBSD 7.1 on Raspberry PI 4B 8GB](https://www.reddit.com/r/openbsd/comments/xcudgr/openbsd_71_on_raspberry_pi_4b_8gb/)  社区实践经验，记录树莓派 4B 上 OpenBSD 的安装过程。
- [OpenBSD On A Raspberry Pi 4](https://www.mtsapv.com/rpi4obsd/)  树莓派 4 上 OpenBSD 安装与配置的技术指南。
- [树莓派官方文档简体中文版](https://rpicn.bsdcn.org)  树莓派硬件与使用的中文参考文档。

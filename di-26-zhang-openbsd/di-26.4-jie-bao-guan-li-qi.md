...
- [Ports - Working with Ports](https://www.openbsd.org/faq/ports/ports.html)  官方 Ports 系统使用指南，详解源码包编译流程。
- [Anonymous CVS](https://www.openbsd.org/anoncvs.html)  官方 CVS 匿名访问说明，提供代码获取方法。

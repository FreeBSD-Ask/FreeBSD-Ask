...
包管理器是操作系统中用于管理软件安装、升级和卸载的重要工具。OpenBSD 提供了多种软件安装方式供用户选择。
...
- [Ports - Working with Ports](https://www.openbsd.org/faq/ports/ports.html) [备份](https://web.archive.org/web/20260116122228/https://www.openbsd.org/faq/ports/ports.html)

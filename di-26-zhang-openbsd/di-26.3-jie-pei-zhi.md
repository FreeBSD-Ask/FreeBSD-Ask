...
- [OpenBSD FAQ](https://www.openbsd.org/faq/) ——[中文版在此](https://openbsd-zh-association.github.io/docs-openbsd-zh/)  官方系统配置与使用指南，提供完整参考。
...
- [Installing OpenBSD 7.3 on your laptop is really hard (not)](https://www.k58.uk/openbsd.html)  笔记本电脑安装 OpenBSD 的实践指南。

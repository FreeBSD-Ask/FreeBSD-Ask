# 27.1 FreeBSD 源代码目录结构

本节介绍 FreeBSD 操作系统源代码的目录组织结构，帮助读者建立对 FreeBSD 代码库的认知。理解源代码目录结构是深入系统开发、定制和优化的基础。

## FreeBSD src 目录结构

了解 FreeBSD 源代码的目录结构有助于理解系统组织方式。下图展示了 FreeBSD 系统源代码的整体目录结构：

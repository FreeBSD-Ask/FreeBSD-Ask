...
>**警告**
>
>由于 [Bug 7836](https://github.com/pgadmin-org/pgadmin4/issues/7836)、[Bug 8869](https://github.com/pgadmin-org/pgadmin4/issues/8869) pgAdmin4 目前无法通过 pip 安装，本文暂时无效。
...
- [PostgreSQL WIKI FreeBSD]([https://docs.vultr.com/install-pgadmin-4-for-postgresql-on-freebsd-12-2](https://wiki.freebsd.org/PostgreSQL/Setup))

...
> **警告**
>
>请注意 [Bug 7836](https://github.com/pgadmin-org/pgadmin4/issues/7836) [备份](https://web.archive.org/web/20260115143428/https://github.com/pgadmin-org/pgadmin4/issues/7836)、[Bug 8869](https://github.com/pgadmin-org/pgadmin4/issues/8869) [备份](https://web.archive.org/web/20260115143444/https://github.com/pgadmin-org/pgadmin4/issues/8869)。
...
说明：pip 是 Python 包的包管理器，用于安装和管理 Python 包以及依赖包的关系。
...
└── usr/
    └── ports/
        ...
        ├── devel/
        │   ├── py-pip/        # pip 源码端口
        │   └── py-virtualenv/ # virtualenv 源码端口
        └── databases/
            └── py-sqlite3/    # py-sqlite3 源码端口
```
...
如需升级 pgAdmin4，可以按以下步骤进行。

在本文测试中，直接使用 pip 升级 pgAdmin4 仍可能显示旧版本信息。

pgadmin4 更新频率较高，如需升级要先删除原有用 virtualenv 创建的 pgadmin4 目录，然后用安装用户再次执行如下指令，创建名为 pgadmin4 的 Python 虚拟环境：
...
- [PostgreSQL WIKI FreeBSD](https://wiki.freebsd.org/PostgreSQL/Setup) [备份](https://web.archive.org/web/20260115143441/https://wiki.freebsd.org/PostgreSQL/Setup)，系统介绍 FreeBSD 环境下 PostgreSQL 的安装配置方法，为本章提供官方指南参考。

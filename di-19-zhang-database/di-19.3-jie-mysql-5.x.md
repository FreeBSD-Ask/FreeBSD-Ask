...
目前 FreeBSD 官方软件源中已不再提供 MySQL 5.5/5.6/5.7 等版本的预编译包，相关软件包的历史状态可参见 [https://www.freshports.org/databases/mysql55-server](https://www.freshports.org/databases/mysql55-server) 、[https://www.freshports.org/databases/mysql56-server](https://www.freshports.org/databases/mysql56-server) 和 [https://www.freshports.org/databases/mysql57-server](https://www.freshports.org/databases/mysql57-server)。
...
└── usr/
    └── ports/
        └── databases/
            ├── mysql55-server/  # MySQL 5.5 Server 源码端口
            ├── mysql56-server/  # MySQL 5.6 Server 源码端口
            └── mysql57-server/  # MySQL 5.7 Server 源码端口
```
...
MySQL 5.7 的安装方式与 5.5/5.6 类似，也需要拉取旧版的 ports 编译安装。

...
值得一提的是，PostgreSQL 也渊源于加州大学伯克利分校。PostgreSQL 的许可证是 [PostgreSQL 许可证](https://www.postgresql.org/about/licence/) [备份](https://web.archive.org/web/20260115143345/https://www.postgresql.org/about/licence/)，与 BSDL 类似。
...
- 示例输出（我设置了 i18n，如果你的输出是英文也是正常的）：初始化 PostgreSQL 数据库实例。

...
PostgreSQL 采用 [PostgreSQL 许可证](https://www.postgresql.org/about/licence/) [备份](https://web.archive.org/web/20260115143345/https://www.postgresql.org/about/licence/)，该许可证与 BSD 许可证同属宽松开源许可范畴，对商业使用与修改限制较少，是开放源码社区广泛采用的许可协议之一。
...
3. 使用 PostgreSQL 部署一些常见服务，如 Typecho，WordPress，并完善他们对 PostgreSQL 的支持，贡献上游。

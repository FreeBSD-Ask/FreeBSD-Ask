...
本章将系统介绍在 FreeBSD 操作系统上部署 Apache Web 服务器的方法与实践。
...
├── etc/
│   └── apache24/
│       ├── httpd.conf          # Apache 主配置文件（实际生效配置）
...
2. 在 FreeBSD 中，基于 Apache24 配置 HTTPS 支持，实现自动签名。

3. 在 FreeBSD 中，基于 Apache24 部署一个 WordPress 或 Typro。

...
```sh
# rabbitmqctl --erlang-cookie `cat /var/db/rabbitmq/.erlang.cookie` add_user onlyoffice z  # 注意：z 为我设置的密码，会卡几分钟
...
![Document Server is running](../.gitbook/assets/documentserver2.png)

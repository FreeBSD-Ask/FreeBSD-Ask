...
>**注意**
>
>本文写作时 Nextcloud 与 php84 尚不兼容，会显示以下内容：
>
>```sh
...
![nextcloud Port](../.gitbook/assets/nextclould1.png)

请输入你需要的登录账户和密码。其他照抄即可。

![nextcloud Port](../.gitbook/assets/nextclould2.png)

安装完成会重定向到插件推荐：不必理会，重新定位到 "http://ip/nextcloud" 即可正常使用之。

![nextcloud Port](../.gitbook/assets/nextclould3.png)

![nextcloud Port](../.gitbook/assets/nextclould4.png)

...
详情参见 [官方文档](https://docs.influxdata.com/telegraf/v1.26/configuration/) [备份](https://web.archive.org/web/20260114210354/https://docs.influxdata.com/telegraf/v1/configuration/)，提供 Telegraf 完整配置参数及插件使用说明。
...
数据源配置完成后，可以配置 Dashboard 来可视化展示监控数据。选择用于展示数据的 Dashboard，可以自行开发，也可以使用 [官方模板库](https://grafana.com/grafana/dashboards/) [备份](https://web.archive.org/web/20260115142046/https://grafana.com/grafana/dashboards/) 中其他人开发的模板，提供丰富的社区贡献仪表板资源。

此处导入 id 为 [928](https://grafana.com/grafana/dashboards/928-telegraf-system-dashboard/) [备份](https://web.archive.org/web/20260115142101/https://grafana.com/grafana/dashboards/928-telegraf-system-dashboard/) 的模版，该模板专为 Telegraf 系统监控设计，展示全面的系统指标。

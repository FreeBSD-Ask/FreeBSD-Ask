...
选择用于展示数据的 Dashboard，可以自行开发，也可以使用 [官方模版库](https://grafana.com/grafana/dashboards/) [备份](https://web.archive.org/web/20260115142046/https://grafana.com/grafana/dashboards/) 中其他人开发的模板。

...
- [PostgreSQL15 Public Schema 没有权限问题解决](https://showme.codes/zh-cn/2024-01-01-postgresql15-public-schema-permission/) ，详述 PostgreSQL 15+ 中 public schema 权限变更及解决方案。
...
- [Monitor Your Hosts with Zabbix](https://freebsdfoundation.org/our-work/journal/browser-based-edition/networking-10th-anniversary/practical-ports-monitor-your-hosts-with-zabbix/) ，提供 FreeBSD 上 Zabbix 监控部署的完整实践指南。

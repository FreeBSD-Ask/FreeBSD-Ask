...
- [Install PHP 8.0 on FreeBSD 13 / FreeBSD 12](https://computingforgeeks.com/how-to-install-php-8-on-freebsd-system/)，详细讲解 FreeBSD 上 PHP 8 安装步骤及依赖处理
- [PHP-FPM(8)](https://man.freebsd.org/cgi/man.cgi?query=php-fpm)，man 页面，系统阐述 PHP-FPM 进程管理机制及配置参数
- [Apache and PHP](https://forums.freebsd.org/threads/apache-and-php.80625/) [备份](https://web.archive.org/web/20260115141813/https://forums.freebsd.org/threads/apache-and-php.80625/)，提供 Apache 与 PHP 集成配置的实践经验，提示安装 `mod_php84`
...
- [Install PHP 8.0 on FreeBSD 13 / FreeBSD 12](https://computingforgeeks.com/how-to-install-php-8-on-freebsd-system/)，提供完整的 PHP 安装与配置指导，文章主体框架来源此
...
- [How to Install PHP and PHP-FPM on FreeBSD 14.0](https://docs.vultr.com/how-to-install-php-and-php-fpm-on-freebsd-14-0) [备份](https://web.archive.org/web/20260115141744/https://docs.vultr.com/how-to-install-php-and-php-fpm-on-freebsd-14-0)，本文曾主要参考此文，提供 Nginx 与 PHP-FPM 集成的详细步骤

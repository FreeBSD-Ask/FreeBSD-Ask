...
- [Apache and PHP](https://forums.freebsd.org/threads/apache-and-php.80625/) ，提供 Apache 与 PHP 集成配置的实践经验，提示安装 `mod_php84`
...
- [How to Install PHP and PHP-FPM on FreeBSD 14.0](https://docs.vultr.com/how-to-install-php-and-php-fpm-on-freebsd-14-0) ，本文曾主要参考此文，提供 Nginx 与 PHP-FPM 集成的详细步骤

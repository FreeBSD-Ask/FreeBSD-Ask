...
Nextcloud 和 Nginx 准备好后，可以开始安装 OnlyOffice 文档服务器。使用 pkg 安装：
...
- [How to allow Private IP to access onlyOffice documentServer?](https://forum.onlyoffice.com/t/how-to-allow-private-ip-to-access-onlyoffice-documentserver/5755/2) [备份](https://web.archive.org/web/20260115044232/https://community.onlyoffice.com/t/how-to-allow-private-ip-to-access-onlyoffice-documentserver/5755/2)

## 故障排除与未竟事项

在使用 OnlyOffice 过程中如遇到问题，可以查看相关日志文件进行排查。本节还列出了一些待完善的事项。

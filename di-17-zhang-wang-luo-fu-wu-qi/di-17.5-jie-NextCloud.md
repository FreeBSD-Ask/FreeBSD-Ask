...
本节将介绍基于 PostgreSQL 数据库在 FreeBSD 上安装和配置 Nextcloud 的方法。
...
- [System requirements](https://docs.nextcloud.com/server/latest/admin_manual/installation/system_requirements.html) [备份](https://web.archive.org/web/20260115044800/https://docs.nextcloud.com/server/latest/admin_manual/installation/system_requirements.html)，明确列出 Nextcloud 各组件的版本兼容性要求
- [PHP Modules & Configuration](https://docs.nextcloud.com/server/latest/admin_manual/installation/php_configuration.html) [备份](https://web.archive.org/web/20260116023053/https://docs.nextcloud.com/server/latest/admin_manual/installation/php_configuration.html)，详细说明必需与可选的 PHP 模块及性能优化配置

## 课后习题

1. 在 FreeBSD 中，基于 Nginx 和 PostgreSQL 部署 Nextcloud。

2. 修改 Nextcloud 默认的文件权限配置，使其更合理，能在能够在互联网中使用。

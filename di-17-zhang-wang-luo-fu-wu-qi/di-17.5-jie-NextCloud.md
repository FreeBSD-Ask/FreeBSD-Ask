...
- [System requirements](https://docs.nextcloud.com/server/latest/admin_manual/installation/system_requirements.html) ，明确列出 Nextcloud 各组件的版本兼容性要求
- [PHP Modules & Configuration](https://docs.nextcloud.com/server/latest/admin_manual/installation/php_configuration.html) ，详细说明必需与可选的 PHP 模块及性能优化配置

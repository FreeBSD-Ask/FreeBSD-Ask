...
```
# pkg ins php84-pdo_pgsql php84-pgsql
```

或

```
# cd /usr/ports/databases/php84-pdo_pgsql/ && make install clean
# cd /usr/ports/databases/php84-pgsql/ && make install clean
```
...
GRANT
template1=# psql -U zabbix zabbix # 使用用户账户 zabbix 登录到数据库 zabbix
template1-# \i schema.sql # 导入数据库，下同
CREATE TABLE
CREATE INDEX
CREATE TABLE
CREATE INDEX

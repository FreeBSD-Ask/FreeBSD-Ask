...
$ cd OpenList/public
$ fetch https://github.com/OpenListTeam/OpenList-Frontend/releases/download/v4.0.8/openlist-frontend-dist-v4.0.8.tar.gz   # 这是前端部分，官方已经编译好的，注意和后端版本相对应
$ tar openlist-frontend-dist-v4.0.8.tar.gz  # 解压缩
...
### 编写 `/usr/local/etc/rc.d/openlist`
...
```sh
root@ykla:/home/ykla/OpenList/build # ./openlist admin
...
- [从源码运行](https://docs.oplist.org/zh/guide/install/source.html)，官方文档

...
- [exporter 配置参考](https://github.com/prometheus/exporter-toolkit/blob/master/docs/web-configuration.md) [备份](https://web.archive.org/web/20260115141625/https://github.com/prometheus/exporter-toolkit/blob/master/docs/web-configuration.md)，提供 Exporter 安全认证与 TLS 配置的完整说明
- [prometheus 配置参考](https://github.com/prometheus/prometheus/blob/main/docs/configuration/configuration.md) [备份](https://web.archive.org/web/20260120143514/https://github.com/prometheus/prometheus/blob/main/docs/configuration/configuration.md)，详述 Prometheus 主配置文件的完整参数集
- [远程存储相关](https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage) [备份](https://web.archive.org/web/20260115044410/https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage)，介绍 Prometheus 远程读写接口及集成方案
- [alertmanager 配置参考](https://prometheus.io/docs/alerting/latest/configuration/) [备份](https://web.archive.org/web/20260117172122/https://prometheus.io/docs/alerting/latest/configuration/)，提供告警路由与通知渠道的完整配置指南

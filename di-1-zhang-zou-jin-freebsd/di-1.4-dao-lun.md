...
- FreeBSD 的代码风格是 Kernighan & Ritchie 经典著作 *The C Programming Language*（中译本：Kernighan, B. W., Ritchie, D. M. C 程序设计语言 (原书第 2 版)[M]. 徐宝文, 李志, 译. 尤晋元, 审校. 北京: 机械工业出版社, 2019. ISBN 9787111617945.）中使用的风格。

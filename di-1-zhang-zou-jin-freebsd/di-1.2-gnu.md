...
让我们先从 Linux 内核文档中的相关内容开始了解。根据 Linux 内核文档 [1.5. Licensing](https://www.kernel.org/doc/html/latest/process/1.Intro.html)（另见 [Linux kernel licensing rules](https://www.kernel.org/doc/html/latest/process/license-rules.html)）：
...
以下是笔者与 RMS 的私人通信。其强调的 GNU 与自由软件运动并不强调“开源”（甚至是反对开源），而是强调“Free”式自由。有些人可能认为现在的“开源”仅仅是由 [OSI 定义](https://opensource.org/osd) 的那样，这是一种不全面的观点。
...
在讨论自由软件与开源软件时，常常会出现各种误解和混淆。我们必须先给自由软件和开源协议分别下个定义，我们引用 [GNU 网站](https://www.gnu.org/philosophy/free-sw.zh-cn.html) [备份](https://web.archive.org/web/20260121155047/https://www.gnu.org/philosophy/free-sw.zh-cn.html) 的相关内容来定义什么是自由软件的自由。

...
GNU 操作系统和自由软件运动对现代开源软件的发展产生了深远的影响。让我们先从 Linux 内核文档中的相关内容开始了解。根据 Linux 内核文档 [1.5. Licensing](https://www.kernel.org/doc/html/latest/process/1.Intro.html)（另见 [Linux kernel licensing rules](https://www.kernel.org/doc/html/latest/process/license-rules.html)）：
...
由于 Unix 在后期愈发封闭，许可证昂贵且受限于商业公司等原因，理查德·马修·斯托曼（Richard Matthew Stallman，RMS）希望创造一款自由且兼容 Unix 的操作系统。

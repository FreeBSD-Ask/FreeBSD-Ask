...
由于 Unix 在后期发展中逐渐呈现封闭化趋势，许可证价格高昂且使用权受到商业公司的严格限制等多重原因，理查德·马修·斯托曼（Richard Matthew Stallman，RMS）希望创造一款自由且与 Unix 兼容的操作系统。这一愿景不仅是技术层面的追求，更是对软件自由理念的深刻实践与制度性探索。Unix 从最初开放的研究项目逐渐转变为商业产品，普通用户无法再自由获取和修改其源代码，这一转变直接触发了自由软件运动的兴起。

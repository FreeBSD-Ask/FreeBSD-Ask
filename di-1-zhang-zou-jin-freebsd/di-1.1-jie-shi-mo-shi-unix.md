...
>**思考题**
>
>常见的 Linux 发行版和所谓的国产操作系统，究竟在维护着什么？内核和 glibc 他们不维护，桌面他们不维护，其他第三方软件他们也不维护，甚至就连包管理器和软件源他们也都不维护。
>
>这些 Linux 发行版间在本质上究竟有什么区别，这是一个忒休斯问题吗？
>
>如果去掉 Linux 内核，去掉 Shell，去掉桌面，再去掉包管理器，去掉任何第三方软件，这些 Linux 发行版还能剩下什么？

...
20 世纪 70 年代，加州大学伯克利分校的计算机科学研究人员开始对 AT&T 贝尔实验室开发的 UNIX 操作系统进行修改与扩展。由于这些修改与扩展最初以软件发行包的形式发布，因此被称为 Berkeley Software Distribution（BSD）。

~~尽管该教材表述被认为有误，且部编版必修四《哲学与文化》ISBN 9787107341953 已删去相关内容~~，你都能找到他的身影，而关于他的哲学实验也是哲学考试中经久不衰的论述题。
BSD 项目在计算机操作系统发展史上具有重要地位，它不仅引入了许多关键的技术创新，还成为了包括 FreeBSD、OpenBSD、NetBSD 等现代开源操作系统的基础。

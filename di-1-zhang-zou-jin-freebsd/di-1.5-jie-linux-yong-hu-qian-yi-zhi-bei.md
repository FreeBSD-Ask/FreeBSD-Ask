...
稳定性是绝对谈不上的，无法跨大版本升级（必挂，除非纯净系统），与 deb 系不同，即使是细微差别的大版本，软件源亦无法通用。

由此可见 Linux 所谓成功的商业模式就是开源社区免费测试，测试稳定了引入企业版。更多地例如 wine 与 crossover？这个系统这几年非常吃资源，在虚拟机的 4G 内存完全无法满足他，必须给更多才能进行安装。

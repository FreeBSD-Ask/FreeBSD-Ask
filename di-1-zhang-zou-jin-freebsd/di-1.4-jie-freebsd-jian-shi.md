...
贝克莱悖论从未并未被解决。ε‑δ 定义只是让实分析在 ZFC 公理体系下变得形式自洽。许多人往往会用上述定义去解决[芝诺（Zeno of Elea）悖论](https://plato.stanford.edu/entries/paradox-zeno/)，进而否定其哲学价值。

更多相关资源请参看非标准分析教程以及数学哲学相关书籍。

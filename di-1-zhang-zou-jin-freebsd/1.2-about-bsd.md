...
FreeBSD 核心小组是 FreeBSD 项目的最高权力机关，共计 9 人，FreeBSD 核心小组采取集体领导制度，每位成员分管不同的子项目。FreeBSD 核心小组负责授予或撤销提交者权限及账户、执行冲突守则（CoC）、管理项目子团队等。FreeBSD 核心小组选举每两年举行一次，可以连选连任。只有在过去一年内有过提交的提交者（成为活跃开发者）才有资格投票参见选举，被选举者也必须是提交者。活跃开发者可以表决罢免 FreeBSD 核心小组成员。

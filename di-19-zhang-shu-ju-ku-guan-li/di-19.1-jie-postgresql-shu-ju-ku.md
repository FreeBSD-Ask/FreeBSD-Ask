...
PostgreSQL 是一款自由的对象关系型数据库管理系统（Object-Relational Database Management System，ORDBMS），在现代数据管理领域兼具重要学术价值与广泛产业应用。其学术源流可追溯至加州大学伯克利分校的 Ingres 项目，随后 Michael Stonebraker 教授在此基础上启动了后继项目 POSTGRES（意为“post-Ingres”后 Ingres 时代），首个版本于 1989 年 6 月发布。

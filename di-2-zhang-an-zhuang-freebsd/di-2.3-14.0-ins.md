...
这些 RELEASE 系统亦可用于生产环境，但其优先级低于最新的 RELEASE。本节将系统介绍 FreeBSD 13 和 14 版本的安装流程。
...
> **技巧**
>
> 视频教程见 [FreeBSD 14.2 基础安装配置教程](https://www.bilibili.com/video/BV1STExzEEhh)（物理机）和 [002-VMware17 安装 FreeBSD 14.2](https://www.bilibili.com/video/BV1gji2YLEoC)（虚拟机）。
...
>
> 本章将指导用户如何使用该工具来进行 FreeBSD 的安装。该工具不仅存在于安装镜像中，安装完成后在新装系统中依然可以找到它，并且还可用它来执行普通的安装流程（此特性在高级安装方式中非常有用）。
>
...
- [libexec/getty/main.c](https://github.com/freebsd/freebsd-src/blob/80c12959679ab203459dc20eb9ece3a7328b7de5/libexec/getty/main.c#L178) [备份](https://web.archive.org/web/20260115144130/https://github.com/freebsd/freebsd-src/blob/80c12959679ab203459dc20eb9ece3a7328b7de5/libexec/getty/main.c#L178)，`Amnesiac` 源码
- [bsdinstall: Warn if hostname is empty](https://github.com/freebsd/freebsd-src/pull/1700) [备份](https://web.archive.org/web/20260115144314/https://github.com/freebsd/freebsd-src/pull/1700)，笔者的 PR
...
>
> 原因详情见 [FreeBSD 手册](https://handbook.bsdcn.org/di-18-zhang-cun-chu/18.3.-tiao-zheng-he-zeng-jia-ci-pan-da-xiao.html)，但该现象疑似程序缺陷。
...
> **请勿全选！**
>
> **不要** 选择 `local_unbound`，否则可能影响系统 DNS 解析（参见 [Bug 262290 - After a normal FreeBSD installation and reboot, /etc/resolv.conf will be changed](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=262290)）。除非明确了解其用途。

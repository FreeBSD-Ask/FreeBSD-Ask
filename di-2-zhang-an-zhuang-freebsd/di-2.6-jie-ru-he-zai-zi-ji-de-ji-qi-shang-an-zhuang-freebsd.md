...
> **警告**
>
> **请不要** 问我在安装中应该选用哪个镜像站这类问题，那是因为你的错误操作导致的（全选了组件）。
>
...
> **警告**
>
>**iso 镜像并不适用于物理机（普通电脑），物理机（普通电脑）请使用 img 镜像。** **除非你有光盘，否则不要下 ISO；**

>**技巧**
>
>FreeBSD 14.1 RELEASE 两个 ISO 均在 Ventoy 下测试通过（UEFI）。但是仍不排除出现问题的可能性。如果出现问题，请首先考虑下载 `img` 正常刻录。

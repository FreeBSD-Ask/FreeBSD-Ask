...
![FreeBSD 安装程序的欢迎界面](../.gitbook/assets/ins3.png)
...
![键盘布局选择](../.gitbook/assets/ins4-15.png)
...
除了软件包安装方式外，还可以选择传统的发行组件安装方式。这是传统的安装方式，成熟稳定。

![选择安装组件](../.gitbook/assets/ins6-15-2.png)
...
>
> 推荐在默认选项基础上，**额外** 选中 `src`。因为部分显卡驱动程序（如 `drm`）及其他程序需要源码，且经测试 `lib32` 组件在系统安装后单独安装可能无效。
...
![磁盘分区菜单](../.gitbook/assets/ins7-15.png)
...
![ZFS 配置](../.gitbook/assets/ins8-15.png)
...
| `E Encrypt Disks? NO` | 加密磁盘？否 | 加密后的登录系统方案请参考本书其他文章 |
...
![选择虚拟设备类型](../.gitbook/assets/ins9-15.png)
...
![选择目标硬盘](../.gitbook/assets/ins10-15.png)
...
![确认格式化](../.gitbook/assets/ins12-15.png)
...
![安装过程](../.gitbook/assets/ins13-15.png)
...
![设置 root 密码](../.gitbook/assets/ins15-15-2.png)
...
![选择网络接口](../.gitbook/assets/ins17-15.png)
...
![自动配置网络](../.gitbook/assets/ins18-15.png)
...
![选择启动服务](../.gitbook/assets/ins28-15.png)
...
> **警告**
>
> **不要** 选择 `local_unbound`，否则可能影响系统 DNS 解析（参见 FreeBSD Project. Bug 262290: After a normal FreeBSD installation and reboot, /etc/resolv.conf will be changed[EB/OL]. [2026-03-25]. <https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=262290>。该 Bug 报告记录 local_unbound 服务导致 resolv.conf 变更问题）。除非你明确了解其用途。
...
![填写用户信息](../.gitbook/assets/ins31-15.png)
...
![完成安装](../.gitbook/assets/ins32-15.png)
...
![是否进入 Shell](../.gitbook/assets/ins33-15.png)
...
![系统启动](../.gitbook/assets/ins35-15.png)
...
> FreeBSD 基本系统默认不包含图形界面（未安装 Xorg），因此启动后将进入文本控制台界面（TTY）。
 ...
 ![登录界面](../.gitbook/assets/ins36-15.png)
...
> 密码是不会显示在屏幕上的（包括 `*` 号），就是什么也没有，输入完毕后直接按回车键即可。
 ...
 ![登录成功](../.gitbook/assets/ins37-15.png)

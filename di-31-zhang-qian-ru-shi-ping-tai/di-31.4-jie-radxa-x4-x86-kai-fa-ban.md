...
推荐安装 FreeBSD 15.0-RELEASE（当前最新 Production Release，2025 年 12 月发布）或更新版本。

> **已知问题（Bug 271548）**
>
> FreeBSD 在 Alder Lake 处理器上存在一个长期未修复的 Bug：无法正确处理混合架构（P-core/E-core），导致选择了所有核心中最低的最大频率，主频无法达到标称值。该 Bug 最早于 13.2-STABLE 被报告，截至 15.0-RELEASE（当前最新 Production Release）仍未修复。如需完整性能，可在 BIOS 中禁用 E-core 以规避此问题。

...
请安装 FreeBSD 15.0-RELEASE 或更新版本。当前 FreeBSD 存在一个已知问题（Bug 271548）：Alder Lake CPU 在主频管理上存在缺陷，无法正确处理混合架构（P-core/E-core），导致选择了所有核心中最低的最大频率，主频无法达到标称值。该 Bug 自 13.2-STABLE 时代起即存在，至今仍未修复。如需完整性能，可在 BIOS 中禁用 E-core 以规避此问题。

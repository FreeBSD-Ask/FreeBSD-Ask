...
- FreeBSD Project. mount -- mount file systems[EB/OL]. [2026-04-14]. <https://man.freebsd.org/cgi/man.cgi?query=mount&sektion=8&manpath=FreeBSD+16.0-CURRENT>. 文件系统挂载命令手册页。
- FreeBSD Project. growfs -- expand a UFS file system[EB/OL]. [2026-04-14]. <https://man.freebsd.org/cgi/man.cgi?query=growfs&sektion=8&manpath=FreeBSD+16.0-CURRENT>. UFS 文件系统扩容工具手册页。
- FreeBSD Project. fsck_ffs -- file system consistency check and interactive repair[EB/OL]. [2026-04-14]. <https://man.freebsd.org/cgi/man.cgi?query=fsck_ffs&sektion=8&manpath=FreeBSD+16.0-CURRENT>. UFS 文件系统一致性检查与修复工具手册页。

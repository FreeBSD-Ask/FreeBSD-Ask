...
UFS（UNIX File System，UNIX 文件系统）是 FreeBSD 的原生文件系统，即伯克利快速文件系统（Berkeley Fast File System，FFS），由 Kirk McKusick、Bill Joy 等人于 1983 年随 4.2BSD 首次引入。历史上，macOS 也曾使用该文件系统作为根文件系统。本章介绍磁盘扩容、快照创建与挂载以及配额管理三类操作。

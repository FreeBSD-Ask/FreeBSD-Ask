...
关于 Samba 名称的由来，Samba 官方文档记载：作者 Andrew Tridgell 在开发早期因项目原名涉及他人商标而须更名，遂对一份系统拼写检查词典进行检索，从中提取出含有 s、m、b 三个字母（对应 Server Message Block 协议首字母缩写）的单词，"Samba" 即由此而来。需要指出的是，"samba" 在葡萄牙语及英语中亦有"桑巴舞"之义，此为词形上的巧合。

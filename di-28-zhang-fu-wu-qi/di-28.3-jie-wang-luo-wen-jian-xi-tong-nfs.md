...
现在共享 ZFS 数据集 **zroot/home/ykla**。

```sh
# zfs set sharenfs=on zroot/home/ykla
```
...
zroot/home/ykla  sharenfs  on        local
```

该示例将 **zroot/home/ykla** 导出，以便来自不同域的两个客户端可以访问该文件系统。编辑 **/etc/exports** 文件，添加以下内容：
...
```PowerShell
PS C:\WINDOWS\system32>dism /online /enable-feature /featurename:ServicesForNFS-ClientOnly /all /norestart

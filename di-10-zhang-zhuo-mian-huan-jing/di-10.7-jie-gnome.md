...
GNOME 曾是 GNU 项目的组成部分，旨在构建功能完备的桌面环境，目前主要由 Red Hat 主导开发维护。GNOME 是 Linux 和类 UNIX 系统中的主流桌面环境，设计简洁现代。GNOME 是 GNU Network Object Model Environment 的缩写，作为 GNU 项目，其首字母 G 应发音，读作 /ɡəˈnoʊm/（类似“guh-nome”）。

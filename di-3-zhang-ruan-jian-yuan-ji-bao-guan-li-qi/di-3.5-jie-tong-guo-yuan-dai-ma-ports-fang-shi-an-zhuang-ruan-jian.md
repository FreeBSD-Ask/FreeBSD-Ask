...
>
> * 人们应该能够轻松地使用在基本系统或 git 来使用 pkg 的 svnlite。(似乎很少有人真正使用 WITHOUT\_SVNLITE)。
...
> * 让 WITHOUT\_PORTSNAP 成为默认的基本系统参数。目前还不确定这一点何时会发生。可能在 13.0 之前不会发生，但希望它能生效。

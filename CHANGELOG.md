...
- 2026.5.28
  - 新增第 21 章 Linux Jail，包含 21.1 Linux Jail 基础准备、21.2 创建 Debian Jail、21.3 创建 Ubuntu Jail、21.4 创建 antiX Linux Jail、21.5 Jail 中的 GUI，内容均置空
  - 新增 10.8 摄像头
  - 删除 12.8 Linux Jail
  - 删除 20.2 Jail 系统更新
  - 原有章节序号依次递归：原第 21-29 章分别调整为第 22-30 章（虚拟化与容器管理→22、数据库管理→23、FTP→24、服务器→25、Web 服务器→26、监控系统→27、嵌入式平台→28、开发环境→29、FreeBSD 内核架构→30）
  - 同步更新 SUMMARY.md、mu-lu.md 及绪论中的章节描述
- 2026.5.26

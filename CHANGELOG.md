...
- 2026.5.30
  ...
  - 删除"16.1 UFS 文件系统"
  - 删除"16.1 添加磁盘"
  - 新增第 17 章"其他文件系统"（16.4→17.1、16.3→17.2、16.5→17.3）
  - 第 16 章新增章节：USB 存储设备、内存盘、加密交换分区
  - 新增第 18 章"UFS 文件系统"（18.1 UFS 文件系统概述、18.2 UFS 磁盘、18.3 UFS 磁盘扩展、18.4 UFS 磁盘快照、18.5 UFS 磁盘配额、18.6 UFS 磁盘加密）
  - 原 17～30 章依次递归更新为 19～32 章
- 2026.5.29
  - 新增“加密磁盘分区”

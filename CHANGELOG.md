...
- 2025.9.30
  ...
  - 由于 Bug 287690 [sysutils/pacman: The archlinux flavor cannot be built or installed.](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=287690)，本文暂不可用，若在六个月内（2025-04-0 1日前）未得到解决将删除“21.5 ArchLinux 兼容层（基于 archlinux-pacman）”。
- 2025.9.28

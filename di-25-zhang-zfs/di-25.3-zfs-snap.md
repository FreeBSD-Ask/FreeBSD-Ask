...
>**思考题**
>
>探索更优的快照回滚方案；已知网络上存在一些相关脚本，可考虑将其作为功能请求或提交 Pull Request（PR）至 OpenZFS 项目。或者使用中文社区的 [ZFS 脚本项目](https://github.com/FreeBSD-Ask/zfs-snap) [备份](https://web.archive.org/web/20260114055056/https://github.com/FreeBSD-Ask/zfs-snap)。

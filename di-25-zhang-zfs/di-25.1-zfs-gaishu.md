...
“时来天地皆同力，运去英雄不自由。”（[唐] 罗隐《筹笔驿》）OpenZFS 新功能的主要开发商 Delphix 公司（Delphix 于 2024 年 2 月被 Perforce Software 收购）将其设备的操作系统从 illumos 迁移到了 Linux，所以基本上放弃了对前者的投入。其理由是几乎所有云平台厂商和虚拟机平台仅支持 Linux，因此 illumos 几乎再难得到投入。甚至 Oracle Solaris 本身也进入了维护模式（版本 11.4 的生命周期可延续至 2037 年）。Oracle ZFS 迁移到了企业级存储解决方案 [Oracle 存储](https://www.oracle.com/cn/storage/#zfs-storage-appliance)。
...
OpenZFS 是在 13.0（2021 年 4 月）引入 FreeBSD 的，“ZFS 的实现目前由 OpenZFS 提供。[9e5787d2284e](https://cgit.freebsd.org/src/commit/?id=9e5787d2284e) （由 iXsystems 赞助）”取代了 OpenSolaris/illumos 版本的 ZFS。这一迁移标志着 FreeBSD 与主流 ZFS 开源生态的重新接轨。
...
- [The Future of ZFS in FreeBSD](https://staging.freebsdfoundation.org/wp-content/uploads/2015/12/2011-FOSDEM-ZFS-in-Open-Source-Operating-Systems.pdf)，Oracle 闭源后的 FreeBSD 项目报告，记录关键时间节点与开发人员。
- [Comprehensive changes for vendored openzfs](https://reviews.freebsd.org/D25872)，切换至 OpenZFS 的代码审查过程文档。
- [9e5787d2284e](https://github.com/freebsd/freebsd-src/commit/9e5787d2284e187abb5b654d924394a65772e004)，GitHub 上的迁移提交记录。
- [History](https://openzfs.org/wiki/History)，OpenZFS 项目官方历史记录。
- [Add support for FreeBSD](https://github.com/openzfs/zfs/pull/8987)，向 OpenZFS 提交的 FreeBSD 支持 PR。
- [Debugging ZFS: From Illumos to Linux by Serapheim Dimitropoulos](https://www.youtube.com/watch?v=uDDJnzSb-2w)，Delphix 迁移使 ZFS 开发集中于 Linux 平台。
- [红帽与实验室携手打造全球性能最强的超级计算机](https://www.redhat.com/zh-cn/success-stories/LLNL)，LLNL 与红帽合作及大规模使用 Linux 的介绍。
- [Oracle and Sun System Software and Operating Systems Oracle Lifetime Support Policy](https://www.oracle.com/us/assets/lifetime-support-hardware-301321.pdf)，Oracle 产品支持周期文档，第 41 页为 Solaris。

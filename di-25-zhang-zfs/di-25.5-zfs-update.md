...
本章阐述 ZFS 存储池版本升级的技术原理、操作流程与风险控制。ZFS 存储池采用功能标记（feature flags）机制进行版本管理，在 FreeBSD 大版本更新时，ZFS 版本通常会相应升级，例如从 14.3 升级到 15.0 时，zpool 的功能集也会随之扩展。本节介绍如何更新 ZFS 存储池以支持新的功能。

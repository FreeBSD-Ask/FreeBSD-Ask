...
│  │                   ESP-IDF 核心组件                     │  │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────────────────┐  │  │
│  │  │ Wi‑Fi 协议栈│ │ BLE/BT   │ │  外设驱动 (SPI/I²C/  │  │  │
│  │  │  (lwIP)   │ │  协议栈   │ │  UART/GPIO/PWM 等)   │  │  │
│  │  └──────────┘ └──────────┘ └──────────────────────┘  │  │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────────────────┐  │  │
│  │  │  FreeRTOS │ │  安全启动 │ │  OTA 升级 / 分区管理  │  │  │
│  │  │  实时内核  │ │  Flash 加密│ │                      │  │  │
│  │  └──────────┘ └──────────┘ └──────────────────────┘  │  │
│  ├──────────────────────────────────────────────────────┤  │
│  │                    硬件抽象层 (HAL)                    │  │
...
│                                                                │
│  ┌──────────┐    ┌──────────┐    ┌──────────┐    ┌──────────┐  │
│  │ 擦除 Flash │───→│ 创建项目  │───→│ 设定目标  │───→│  idf.py  │  │
│  │           │    │           │    │  芯片     │    │  build   │  │
│  │ esptool   │    │ idf.py    │    │ idf.py    │    │          │  │
│  │ erase_    │    │ create-   │    │ set-      │    │ xtensa-  │  │
│  │ flash     │    │ project   │    │ target    │    │ esp-elf- │  │
│  │           │    │           │    │           │    │ gcc      │  │
│  └──────────┘    └──────────┘    └──────────┘    └────┬─────┘  │
│                                                       │        │
│                                                       ▼        │

...
>**注意**
>
>**slackware 并未提供基本系统的下载，需要自己在 slackware 或 FreeBSD 下（FreeBSD 需要安装 `bash` 以及 `gmake`）使用脚本生成，原版脚本地址为 <https://github.com/nnnewb/slackware-WSL>，为了方便.我们制作了一个[基本系统](http://book.bsdcn.org/slackware64-15.0.tar.xz)，基于 15.0，在 FreeBSD 下使用了[我们修改过的脚本](https://github.com/FreeBSD-Ask/slackware-WSL-BSD)即使用了此系统。如果不放心可以自己生成。**

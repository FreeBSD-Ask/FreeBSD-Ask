...
# chmod 0700 /usr/local/sbin/debootstrap # 先赋予权限。
...
现在用 Debian 12 基本系统创建 jail 实例，命名为 debian12
...
教程环境：win 10 物理机，在 virtualbox 安装了 FreeBSD 13.1 虚拟机。

...
Claude Code 是一款 AI 编程助手和自主操作工具，可读取和理解完整的代码库，编辑文件、运行命令，并与开发工具协作，可以在终端、IDE、桌面应用和浏览器中使用，帮助用户快速开发功能、修复漏洞和自动处理开发任务。需要付费订阅使用。
...
如果订阅正常，就可以开始使用了。连续按两次 **Ctrl** + **C** 即可退出该界面

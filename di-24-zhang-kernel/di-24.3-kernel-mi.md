...
本章系统阐述 FreeBSD 内核中与硬件架构无关的通用配置选项。机器无关选项构成了内核的核心抽象层，实现了跨硬件平台的可移植性，是 FreeBSD 多架构支持的基石。以下是相关的参考信息和说明：

- 原文：[freebsd-src/main/sys/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/conf/NOTES) [备份](https://web.archive.org/web/20260118014733/https://github.com/freebsd/freebsd-src/blob/main/sys/conf/NOTES)
- 对应的版本提交：[random: allow disabling of entropy harvesting from keyboard & mice](https://github.com/freebsd/freebsd-src/commit/d6f10a5d013fdcc92847644ffbaf65cbf491bb39) [备份](https://web.archive.org/web/20260121052631/https://github.com/freebsd/freebsd-src/commit/d6f10a5d013fdcc92847644ffbaf65cbf491bb39)。
...
`DEBUG_MEMGUARD` 构建并启用 [memguard(9)](https://man.freebsd.org/cgi/man.cgi?query=memguard&sektion=9&format=html)，这是内核的替代分配器，用于检测释放后使用（use-after-free，UAF）等场景。有关使用的更多信息，请参见 [memguard(9)](https://man.freebsd.org/cgi/man.cgi?query=memguard&sektion=9&format=html) 手册页。
...
IP over InfiniBand (IPoIB)，基于 InfiniBand 的互联网协议，参见 [wiki/InfiniBand](https://wiki.freebsd.org/InfiniBand) [备份](https://web.archive.org/web/20260117114134/https://wiki.freebsd.org/InfiniBand)。
...
>>**思考题**
>>
>>读者可能希望进一步研究这里的缺失条目 `IPFIREWALL_PMOD`，请仔细查阅源代码及 [Add ipfw protocol modification module ipfw_pmod](https://reviews.freebsd.org/D10150) [备份](https://web.archive.org/web/20260117114231/https://reviews.freebsd.org/D10150) 等相关提及，并提交 PR 到 FreeBSD src。
...
Aic7xxx 驱动调试选项。参见 [sys/dev/aic7xxx/aic7xxx.h](https://github.com/freebsd/freebsd-src/blob/main/sys/dev/aic7xxx/aic7xxx.h) [备份](https://web.archive.org/web/20260118014858/https://github.com/freebsd/freebsd-src/blob/main/sys/dev/aic7xxx/aic7xxx.h)。
...
漏洞的具体细节尚不明确，但可在 OpenWrt 论坛[相关讨论帖](https://forum.openwrt.org/viewtopic.php?pid=70060) [备份](https://web.archive.org/web/20260117114303/https://forum.archive.openwrt.org/viewtopic.php?id=14765&p=5#p70060)的第 4、5 和 6 页中找到部分信息。

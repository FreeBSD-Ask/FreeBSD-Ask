...
- iicsmb：使用任意 iicbus 接口的 I2C 到 SMB 桥
...
通过 I²C 桥接的 SMB。可通过 SMB 命令进行 I²C I/O。依赖 `iicbus`。
...
Fairchild 半导体 FAN53555/SYR82x 稳压器。

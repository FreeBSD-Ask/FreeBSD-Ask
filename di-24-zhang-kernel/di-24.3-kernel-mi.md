...
在调试输出中打印寄存器位字段。会使驱动增加约 128KB 的大小。参见：ahc(4)[EB/OL]. [2026-03-26]. <https://man.freebsd.org/cgi/man.cgi?query=ahc&sektion=4>。
...
Aic79xx 驱动调试选项。会使驱动增加约 215KB。参见：ahd(4)[EB/OL]. [2026-03-26]. <https://man.freebsd.org/ahd(4)>。

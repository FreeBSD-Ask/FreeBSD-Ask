...
- RISC-V 内核配置选项位于 [riscv/conf](https://github.com/freebsd/freebsd-src/tree/main/sys/riscv/conf)
...
- [sys/arm/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/arm/conf/NOTES)：armv7/32 位 arm 机器相关的内核配置说明文件。不到 100 余行。

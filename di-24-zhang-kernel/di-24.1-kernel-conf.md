...
- amd64 架构的内核配置选项位于 [sys/amd64/conf](https://github.com/freebsd/freebsd-src/tree/main/sys/amd64/conf) [备份](https://web.archive.org/web/20260118170007/https://github.com/freebsd/freebsd-src/tree/main/sys/amd64/conf)
- arm64 架构的内核配置选项位于 [sys/arm64/conf](https://github.com/freebsd/freebsd-src/tree/main/sys/arm64/conf) [备份](https://web.archive.org/web/20260118170009/https://github.com/freebsd/freebsd-src/tree/main/sys/arm64/conf)
- RISC-V 架构的内核配置选项位于 [sys/riscv/conf](https://github.com/freebsd/freebsd-src/tree/main/sys/riscv/conf) [备份](https://web.archive.org/web/20260118014519/https://github.com/freebsd/freebsd-src/tree/main/sys/riscv/conf)
...
- `FIRECRACKER`：面向 [Firecracker](https://firecracker-microvm.github.io/) [备份](https://web.archive.org/web/20260118170105/https://firecracker-microvm.github.io/) 虚拟机环境的内核配置文件，参见 [amd64: Add FIRECRACKER kernel configuration](https://reviews.freebsd.org/D36672) [备份](https://web.archive.org/web/20260117175525/https://reviews.freebsd.org/D36672)

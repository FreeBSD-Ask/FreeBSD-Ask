...
本章系统阐述 FreeBSD 内核中与特定硬件架构相关的配置选项。机器相关选项是内核配置的重要组成部分，它们针对不同处理器架构（如 x86、ARM、RISC-V 等）的硬件特性进行优化和适配，是实现硬件抽象层的关键机制，对系统性能与兼容性具有决定性影响。以下是相关的参考信息和说明：

- 原文：[amd64/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/amd64/conf/NOTES) [备份](https://web.archive.org/web/20260119041443/https://github.com/freebsd/freebsd-src/blob/main/sys/amd64/conf/NOTES)
- 版本：[mpi3mr: Broadcom's MPT-Fusion version 4 is amd64 and aarch64 only](https://github.com/freebsd/freebsd-src/commit/2f721943bf20e53b0ba7b5032a2900d0beb67413) [备份](https://web.archive.org/web/20260118170751/https://github.com/freebsd/freebsd-src/commit/2f721943bf20e53b0ba7b5032a2900d0beb67413)
...
amd64（x86-64）架构作为当代服务器和桌面系统的主流平台，其内核配置选项涵盖了从硬件抽象到性能优化的多个维度。本节首先介绍 amd64 架构特有的内核配置选项：
...
接下来介绍 i386 和 amd64 两种 x86 架构共用的内核配置选项。以下是相关的参考信息：

原文 [x86/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/x86/conf/NOTES) [备份](https://web.archive.org/web/20260118015431/https://github.com/freebsd/freebsd-src/blob/main/sys/x86/conf/NOTES)，版本 [NOTES: Add iwm and iwx](https://github.com/freebsd/freebsd-src/commit/b1039bbe185bbadea24207b600f4bea065a2dbee) [备份](https://web.archive.org/web/20260118015523/https://github.com/freebsd/freebsd-src/commit/b1039bbe185bbadea24207b600f4bea065a2dbee)。
...
- 原文：[sys/arm64/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/arm64/conf/NOTES) [备份](https://web.archive.org/web/20260118015413/https://github.com/freebsd/freebsd-src/blob/main/sys/arm64/conf/NOTES)：aarch64 机器相关的内核配置说明文件。版本：[LINT: add KDTRACE_MIB_SDT to catch inconsistencies with struct tcpstat](https://github.com/freebsd/freebsd-src/commit/b3d0562dd84540be2fd98e6a457cdcb232e9f915) [备份](https://web.archive.org/web/20260118170814/https://github.com/freebsd/freebsd-src/commit/b3d0562dd84540be2fd98e6a457cdcb232e9f915)。
...
- 原文：[sys/arm/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/arm/conf/NOTES) [备份](https://web.archive.org/web/20260118170931/https://github.com/freebsd/freebsd-src/blob/main/sys/arm/conf/NOTES)：armv7 机器相关的内核配置说明文件。版本：[arm: tweak imx module build logic](https://github.com/freebsd/freebsd-src/commit/5aefe9f16f240696142894bdeabcebbb057c7053) [备份](https://web.archive.org/web/20260119042024/https://github.com/freebsd/freebsd-src/commit/5aefe9f16f240696142894bdeabcebbb057c7053)。

该架构即将被淘汰，因此没有整理内核选项的必要。

## 64 位 RISC-V 机器相关配置

- 原文：[sys/riscv/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/riscv/conf/NOTES) [备份](https://web.archive.org/web/20260118014742/https://github.com/freebsd/freebsd-src/blob/main/sys/riscv/conf/NOTES)：riscv64（64 位 RISC-V）机器相关的内核配置说明文件。100 行。版本：[riscv: support PV_STATS pmap option](https://github.com/freebsd/freebsd-src/commit/88d81453b1151f8b133023073f3a773dd78cdc3a) [备份](https://web.archive.org/web/20260118170916/https://github.com/freebsd/freebsd-src/commit/88d81453b1151f8b133023073f3a773dd78cdc3a)。
...
- 原文：[sys/powerpc/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/powerpc/conf/NOTES) [备份](https://web.archive.org/web/20260118014454/https://github.com/freebsd/freebsd-src/blob/main/sys/powerpc/conf/NOTES)：powerpc、powerpc64、powerpc64le 机器相关的内核配置说明文件，全文不足 100 行。
- 对应版本提交：[LINT: Don't build bnxt on 32-bit platforms](https://github.com/freebsd/freebsd-src/commit/5aefe9f16f240696142894bdeabcebbb057c7053) [备份](https://web.archive.org/web/20260119042024/https://github.com/freebsd/freebsd-src/commit/5aefe9f16f240696142894bdeabcebbb057c7053)。

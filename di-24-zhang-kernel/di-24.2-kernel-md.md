...
- 原文：[sys/arm/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/arm/conf/NOTES)：armv7 机器相关的内核配置说明文件。版本：[arm: tweak imx module build logic](https://github.com/freebsd/freebsd-src/blob/main/sys/arm/conf/NOTES)。
...
- 原文：[sys/powerpc/conf/NOTES](https://github.com/freebsd/freebsd-src/blob/main/sys/powerpc/conf/NOTES)：powerpc/powerpc64/powerpc64le 机器相关的内核配置说明文件。不到 100 行。版本：[LINT: Don't build bnxt on 32-bit platforms](https://github.com/freebsd/freebsd-src/blob/main/sys/powerpc/conf/NOTES)。

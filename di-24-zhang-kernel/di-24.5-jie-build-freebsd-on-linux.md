...
- [Jammy Jellyfish Release Notes](https://discourse.ubuntu.com/t/jammy-jellyfish-release-notes/24668) ，Ubuntu 22.04 LTS 发行说明，参见 systemd v249.11 这一小节。系统介绍 Ubuntu 22.04 的新特性，包括 systemd-oomd 服务。
- [FreeBSD 手册](https://docs.freebsd.org/en/books/handbook/cutting-edge/#building-on-non-freebsd-hosts) ，26.9. Building on non-FreeBSD Hosts，只提供了基本思路，参考价值有限。官方非 FreeBSD 主机构建 FreeBSD 的权威指南。
- [Building on non-FreeBSD hosts](https://wiki.freebsd.org/BuildingOnNonFreeBSD) ，仅提供基本思路，参考价值有限。社区维护的跨平台构建实践经验汇总。

...
1974 年，加州大学伯克利分校的 Bob Fabry 教授从 AT&T 获得了 UNIX 的源代码许可证。Bob Fabry 此前在 1973 年的国际计算机学会（Association for Computing Machinery，ACM）操作系统原理研讨会上见过 UNIX 第 4 版，并有意引入加州大学伯克利分校。1980 年美国国防高级研究计划局（DARPA）与伯克利签订合同后，该校正式成立了计算机系统研究小组（CSRG），开始基于 AT&T Research Unix 进行系统性修改和改进，并将修改后的版本称为“BSD Unix”或“BSD”。

...
在贝尔实验室退出 Multics 项目前，Dennis Ritchie 和 Ken Thompson 已经意识到了 Multics 的潜力。1969 年，Ken Thompson 在一台闲置的 PDP-7 计算机上着手开发一款名为 Unics（Uniplexed Information and Computing Service，**单路复用** 信息和计算服务）的新程序。随后在 1970 年初，他们以开发文本处理（text processing）的名义提出购买申请，在研究部门主管 Lee McMahon 和 Doug McIlroy 的支持下获得资金，于同年 5 月下达订单，夏末收到了 PDP-11/20 计算机，将 Unics 移植到了这台性能更强的机器上。

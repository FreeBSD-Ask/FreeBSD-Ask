...
> **注意**
>
> 只有 ALPHA、BETA、RC 和 RELEASE 才能使用命令 `freebsd-update` 更新系统，其余版本需通过源代码编译或使用二进制的 pkgbase 更新。
...
2. 安装新的 FreeBSD-STABLE 系统，可以从 FreeBSD 镜像站安装最新的 FreeBSD-STABLE 发布版本，或使用基于 FreeBSD-STABLE 的每周快照。

...
- FreeBSD 完全 BSD 化，基本系统除第三方项目外，不含任何 GPL 代码。
- 统一而一致的中央存储库，而非独立的内核项目。
- 便于读者学习操作系统相关课程：以往大多数操作系统课程实际上是“内核原理与实践”，**并非** 真正的“操作系统”课程。
- FreeBSD 项目由核心小组领导。
...
- 基本系统完全 BSD 化，不含有任何 GPL 代码。注：仅 **sys/contrib** 第三方软件包含有少量 GPL 2.0 许可代码，但无任何 GPL 3.0 许可代码。

...
这里我注意到 FreeBSD 13 中 `LC_*` 及 `LANG` 环境变量的默认值为 `"C.UTF-8"`，原来这些环境变量的默认值是 `"C"`。该变化从 FreeBSD 12 开始（来源 [Switch C.UTF-8 as the default locales](https://reviews.freebsd.org/D26973)）。

...
- 继续安装缺少的依赖 `libbz2.so.1.0`：

```sh
# fetch https://dl.rockylinux.org/pub/rocky/9/BaseOS/x86_64/os/Packages/b/bzip2-libs-1.0.8-8.el9.x86_64.rpm
# cd /compat/linux/
root@ykla:/compat/linux # rpm2cpio < bzip2-libs-1.0.8-8.el9.x86_64.rpm  | cpio -id #注意 bzip2-libs-1.0.8-8.el9.x86_64.rpm 的路径改成你自己的
157 blocks
root@ykla:/compat/linux # mv /compat/linux/lib64/libbz2.so.1 /compat/linux/lib64/libbz2.so.1.0 # 重命名所需的库
```
...
- 解决依赖 `libxcb-image.so.0`：

```sh
# fetch https://dl.rockylinux.org/pub/rocky/9/devel/x86_64/os/Packages/x/xcb-util-image-0.4.0-19.el9.0.1.x86_64.rpm
# cd /compat/linux/
root@ykla:/compat/linux # rpm2cpio < xcb-util-image-0.4.0-19.el9.0.1.x86_64.rpm | cpio -id 
47 blocks
```

- 解决依赖 `libxcb-render-util.so.0`：

```sh
# fetch https://dl.rockylinux.org/pub/rocky/9/AppStream/x86_64/os/Packages/x/xcb-util-renderutil-0.3.9-20.el9.0.1.x86_64.rpm
# cd /compat/linux/
root@ykla:/compat/linux #  rpm2cpio < xcb-util-renderutil-0.3.9-20.el9.0.1.x86_64.rpm  | cpio -id 
59 blocks
```

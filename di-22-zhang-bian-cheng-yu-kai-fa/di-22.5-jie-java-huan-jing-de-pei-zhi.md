...
- [Eclipse 2024.03 安装教程（附中文语言设置教程）](https://www.ittel.cn/archives/35394.html) ，提供 Eclipse IDE 安装与中文本地化的详细步骤。
...
- [Eclipse 使用配置全面讲解](https://www.cnblogs.com/xxhxs-21/articles/16417603.html) ，介绍 Eclipse IDE 的常用配置与开发技巧。

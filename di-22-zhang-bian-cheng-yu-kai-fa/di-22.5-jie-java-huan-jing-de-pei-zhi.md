...
FreeBSD 支持 Oracle JDK 与 OpenJDK。Oracle JDK 并非原生支持，需要使用 Linux 二进制兼容层。参见 [https://www.freebsd.org/java/](https://www.freebsd.org/java/) [备份](https://web.archive.org/web/20260116204227/https://wiki.freebsd.org/Java)，FreeBSD 官方 Java 开发环境配置指南。
...
- [Eclipse 2024.03 安装教程（附中文语言设置教程）](https://www.ittel.cn/archives/35394.html) [备份](https://web.archive.org/web/20260116204242/https://www.ittel.cn/archives/35394.html)，提供 Eclipse IDE 安装与中文本地化的详细步骤。
...
- [Eclipse 使用配置全面讲解](https://www.cnblogs.com/xxhxs-21/articles/16417603.html) [备份](https://web.archive.org/web/20260120164250/https://www.cnblogs.com/xxhxs-21/articles/16417603.html)，介绍 Eclipse IDE 的常用配置与开发技巧。

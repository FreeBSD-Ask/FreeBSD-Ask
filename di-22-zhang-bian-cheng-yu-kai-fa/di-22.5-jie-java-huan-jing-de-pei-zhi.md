...
Java 作为跨平台编程语言的典范，其“一次编写，到处运行”的理念与 FreeBSD 的可移植性设计理念形成了有趣的技术呼应。
...
- Eclipse 2024.03 安装教程（附中文语言设置教程）[EB/OL]. [https://www.ittel.cn/archives/35394.html](https://www.ittel.cn/archives/35394.html)，提供 Eclipse IDE 安装与中文本地化的详细步骤。
...
- Eclipse 使用配置全面讲解[EB/OL]. [https://www.cnblogs.com/xxhxs-21/articles/16417603.html](https://www.cnblogs.com/xxhxs-21/articles/16417603.html)，介绍 Eclipse IDE 的常用配置与开发技巧。
...
└── ports/
    └── java/
        └── intellij-ultimate/ # IntelliJ IDEA Ultimate Port
```
...
在 FreeBSD 下使用时可能会出现报错“编辑器中的文件不可运行”，而 Windows 版本则正常。该问题已报告为 [Bug 285130 - Port java/intellij-ultimate always shows This file in the editor is not runnable](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=285130)，记录 IntelliJ IDEA 在 FreeBSD 上的运行问题。

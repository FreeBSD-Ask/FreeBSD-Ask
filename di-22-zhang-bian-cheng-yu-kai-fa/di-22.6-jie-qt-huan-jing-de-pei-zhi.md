...
Qt 作为跨平台应用程序开发框架的代表，其设计哲学与 FreeBSD 的可移植性目标高度契合。在 FreeBSD 上配置 Qt 开发环境，不仅能实现图形界面应用的跨平台开发，更能深入理解框架与底层操作系统之间的交互机制。
...
- [Qt Localization](https://wiki.qt.io/Qt_Localization) [备份](https://web.archive.org/web/20260120212713/https://wiki.qt.io/Qt_Localization)
- [qttranslations](https://invent.kde.org/qt/qt/qttranslations) [备份](https://web.archive.org/web/20260121100401/https://invent.kde.org/qt/qt/qttranslations)

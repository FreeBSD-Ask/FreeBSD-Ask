...
- FreeBSD 镜像构建状态网页：[https://ci.freebsd.org/](https://ci.freebsd.org/) ，提供 FreeBSD 持续集成构建与测试状态的实时监控。
- FreeBSD pkg 二进制软件包构建状态网页：[https://pkg-status.freebsd.org/](https://pkg-status.freebsd.org/) ，提供 Ports 包构建状态与失败分析的可视化界面。
...
- 原方案地址：[where's bsd libc documentation?](https://forums.freebsd.org/threads/wheres-bsd-libc-documentation.63107/) ，作者 mrclksr，探讨 BSD libc 文档生成方法。原方案已失效。

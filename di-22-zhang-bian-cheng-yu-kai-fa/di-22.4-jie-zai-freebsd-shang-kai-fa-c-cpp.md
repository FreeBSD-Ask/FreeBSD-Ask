...
- [algcl](https://github.com/Jianping-Duan/algcl) [备份](https://web.archive.org/web/20260121064214/https://github.com/Jianping-Duan/algcl)，提供可直接运行于 FreeBSD 的 C 语言算法与数据结构编程实例。
...
然后把里面开头的乱码删除即可（删至 `<idea-plugin` 作为开头），重启 CLion 后可正常进入软件。参见 [Bug 290663 - devel/jetbrains-clion: fails to start](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=290663)。记录 CLion 在 FreeBSD 上的启动问题及解决方案。

![](../.gitbook/assets/clion.png)

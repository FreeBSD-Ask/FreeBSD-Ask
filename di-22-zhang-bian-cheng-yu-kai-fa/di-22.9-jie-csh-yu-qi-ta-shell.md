...
- [Powerlevel10k](https://github.com/romkatv/powerlevel10k?tab=readme-ov-file#installation) [备份](https://web.archive.org/web/20260124162843/https://github.com/romkatv/powerlevel10k?tab=readme-ov-file#installation)。主题项目官网
...
└── ports/
    └── shells/
        ├── bash/ # Bash Shell Port
        ├── bash-completion-freebsd/ # FreeBSD Bash 补全库 Port
        └── bash-completion-zfs/ # ZFS Bash 补全库 Port
```
...
> csh 与 tcsh 的关系
>
> 需要注意的是，FreeBSD 中 csh 实际上就是 tcsh，二者没有区别。可以通过查看源代码 [https://github.com/freebsd/freebsd-src/blame/main/bin/csh/Makefile](https://github.com/freebsd/freebsd-src/blame/main/bin/csh/Makefile) [备份](https://web.archive.org/web/20260121063939/https://github.com/freebsd/freebsd-src/blame/main/bin/csh/Makefile) 以及执行 man csh 来验证，都会重定向至 tcsh，提供 csh 与 tcsh 关系的源码佐证。
...
> **注意**
>
> [FreeBSD 14 中的 shell 被统一为了 sh](https://github.com/freebsd/freebsd-src/commit/d410b585b6f00a26c2de7724d6576a3ea7d548b7) [备份](https://web.archive.org/web/20260120164341/https://github.com/freebsd/freebsd-src/commit/d410b585b6f00a26c2de7724d6576a3ea7d548b7)，记录 FreeBSD 14 默认 shell 变更的提交记录。

...
上一节使用 GLPK 求解线性规划问题，本节使用性能更强大的 wxMaxima 来解决问题，该系统不仅可以进行数值计算，还支持符号运算与公式推导。以下代码仅供参考，如果想深入了解，可查看 [官方文档](https://maxima.sourceforge.io/documentation.html)，该文档涵盖 Maxima 计算机代数系统的符号计算、数值分析与公式推导功能，是研究与学习的权威参考资料。
